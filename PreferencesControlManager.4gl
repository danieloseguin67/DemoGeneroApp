{<CODEFILE Path="PreferencesControlManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL PreferencesControlManager_install()

    CONNECT TO "consultcompanion"

    CALL PreferencesControlManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION PreferencesControlManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION PreferencesControlManager_openFirstForm()
    ...
    CALL PreferencesControlTable_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
