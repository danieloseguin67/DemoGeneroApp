{<CODEFILE Path="ClientManagerForm2.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
...
IMPORT FGL ClientManagerForm2_common
IMPORT FGL ClientManagerForm2
IMPORT FGL ClientManagerForm2_events
IMPORT FGL ClientManagerForm2_uidata
IMPORT FGL ClientManagerForm2_uidialogdata
...
DIALOG ClientManagerForm2_uidialog_record1_uiDisplay()
    ...
    DISPLAY ARRAY m_record1_arrRecList TO record1.*
        ...
        BEFORE DISPLAY
            ...
            CALL ClientManagerForm2_uidialog_record1_setActionStates(DIALOG, C_MODE_DISPLAY)
            ...
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_record1_BeforeDisplay IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_BeforeDisplay(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF

            CASE ClientManagerForm2_events.m_DlgCtrlInstruction
        ...
        BEFORE ROW
            ...
            IF (m_record1_keyIndex != DIALOG.getCurrentRow("record1") OR m_prevAction == C_ACTION_CANCEL) THEN
                ...
                CALL ClientManagerForm2_uidialogdata_record1_fetchDetails()
            END IF
            CALL ClientManagerForm2_uidialog_setAllCurrentRow(DIALOG)
            IF NOT libdbapp_isMobile() THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
            END IF

            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_record1_BeforeRow IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_BeforeRow(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION append
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_record1_OnActionAppend IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_OnActionAppend(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION insert
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_record1_OnActionInsert IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_OnActionInsert(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION update
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_record1_OnActionUpdate IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_OnActionUpdate(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --DISPLAY (record1)
            ...
            CALL ClientManagerForm2_uidialog_record1_validateCRUDOperation(DIALOG, m_state, C_ACTION_DELETE) RETURNING l_internalAction
            ...
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_record1_OnActionDelete IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_OnActionDelete(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER DISPLAY
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
        IF ClientManagerForm2_events.m_DlgEvent_record1_AfterDisplay IS NOT NULL THEN
            CALL ClientManagerForm2_events.m_DlgEvent_record1_AfterDisplay(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER ROW
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
        IF ClientManagerForm2_events.m_DlgEvent_record1_AfterRow IS NOT NULL THEN
            CALL ClientManagerForm2_events.m_DlgEvent_record1_AfterRow(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
        END IF
...
DIALOG ClientManagerForm2_uidialog_record1_uiInput()
    DEFINE l_internalAction SMALLINT
    ...
    ATTRIBUTES(WITHOUT DEFAULTS = TRUE, APPEND ROW = TRUE, INSERT ROW = TRUE, DELETE ROW = TRUE)
        BEFORE INPUT
            ...
            IF m_state == C_MODE_ADD THEN
                ...
                END IF
                CALL ClientManagerForm2_uidialogdata_record1_setDefaultValues(DIALOG)
                CALL ClientManagerForm2_uidialogdata_record1_fetchDetails()
            END IF
            CALL ClientManagerForm2_uidialog_record1_setFieldActive(DIALOG, m_state)
            CALL ClientManagerForm2_uidialog_record1_setActionStates(DIALOG, m_state)
            CALL ClientManagerForm2_uidialog_setAllCurrentRow(DIALOG)
            IF NOT libdbapp_isMobile() THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
            END IF
            ...
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_record1_BeforeInput IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_BeforeInput(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER INPUT
            ...
            IF m_dataProcessing THEN --Skip the DVM validation because a data processing is in progress in an other subdialog
                LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            ELSE
                INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            END IF
            IF ClientManagerForm2_events.m_DlgEvent_record1_AfterInput IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_AfterInput(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER ROW
            ...
            CALL ClientManagerForm2_uidialog_record1_validateCRUDOperation(DIALOG, m_state, m_actionNo) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
        ...
        BEFORE INSERT
            ...
            CALL ClientManagerForm2_uidialogdata_record1_setDefaultValues(DIALOG)
            CALL ClientManagerForm2_uidialogdata_record1_fetchDetails()
            CALL ClientManagerForm2_uidialog_record1_setFieldActive(DIALOG, C_MODE_ADD)
            CALL ClientManagerForm2_uidialog_record1_setActionStates(DIALOG, C_MODE_ADD)
            CALL ClientManagerForm2_uidialog_setAllCurrentRow(DIALOG)
            IF NOT libdbapp_isMobile() THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
            END IF
            ...
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_record1_BeforeInsert IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_record1_BeforeInsert(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --MODIFY (record1)
            ...
            CALL ClientManagerForm2_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DELETE) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                    CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                    LET m_dataProcessing = FALSE
        ...
        ON ACTION dialogtouched --INPUT (record1)
            ...
            IF m_state == C_MODE_MODIFY THEN
                CALL ClientManagerForm2_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DIALOGTOUCHED) RETURNING l_internalAction
                CASE l_internalAction
                    WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                        CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                        CONTINUE DIALOG
        ...
        AFTER INSERT
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
    IF ClientManagerForm2_events.m_DlgEvent_record1_AfterInsert IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_record1_AfterInsert(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
            RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
    END IF
    ...
    END CASE
        ...
        BEFORE DELETE
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
    IF ClientManagerForm2_events.m_DlgEvent_record1_BeforeDelete IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_record1_BeforeDelete(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
            RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
    END IF
    ...
    END CASE
        ...
        AFTER DELETE
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
    IF ClientManagerForm2_events.m_DlgEvent_record1_AfterDelete IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_record1_AfterDelete(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
            RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
    END IF
...
DIALOG ClientManagerForm2_uidialog_record1_uiConstruct()
    ...
    CONSTRUCT m_record1_where
        ...
        BEFORE CONSTRUCT
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
        IF ClientManagerForm2_events.m_DlgEvent_record1_BeforeConstruct IS NOT NULL THEN
            CALL ClientManagerForm2_events.m_DlgEvent_record1_BeforeConstruct(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER CONSTRUCT
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
        IF ClientManagerForm2_events.m_DlgEvent_record1_AfterConstruct IS NOT NULL THEN
            CALL ClientManagerForm2_events.m_DlgEvent_record1_AfterConstruct(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
        END IF
...
FUNCTION ClientManagerForm2_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
    ...
    IF l_internalAction == C_INTERNAL_ACTION_PROCESS_OPERATION THEN
        ...
        IF l_action != C_ACTION_DELETE AND l_action != C_ACTION_DIALOGTOUCHED THEN
            ...
            END IF
        END IF
        CALL ClientManagerForm2_uidialog_record1_processCRUDOperation(l_action) RETURNING l_internalAction, l_rec_br_uk.*
    END IF
    IF l_internalAction != C_INTERNAL_ACTION_NEXT_FIELD_CURRENT AND l_internalAction != C_INTERNAL_EXIT_DIALOG THEN
        ...
        IF l_internalAction != C_INTERNAL_ACTION_NO_SYNC THEN
            CALL ClientManagerForm2_uidialog_record1_synchronizeUI(p_dialog, p_state, l_internalAction, l_rec_br_uk.*) RETURNING m_copy_record1.*
        END IF
...
FUNCTION ClientManagerForm2_uidialog_record1_processCRUDOperation(p_action)
    DEFINE p_action SMALLINT
    DEFINE l_internalAction SMALLINT
    DEFINE l_rec_br_uk record1_br_uk_type --key returned by INSERT operation
    DEFINE errNo INTEGER
    ...
    CASE p_action
        WHEN C_ACTION_APPEND --Insert the row in the database
            CALL ClientManagerForm2_uidata.ClientManagerForm2_uidata_record1_insertRow(m_record1_arrRecList[m_record1_keyIndex].*) RETURNING errNo, errMsg, l_rec_br_uk.*
        WHEN C_ACTION_UPDATE --Update the row in the database
            CALL ClientManagerForm2_uidata.ClientManagerForm2_uidata_record1_updateRow(m_record1_arrRecList[m_record1_keyIndex].*, m_record1_arrRecDB[m_record1_keyIndex].*) RETURNING errNo, errMsg
        WHEN C_ACTION_DIALOGTOUCHED --Check the row in the database
            CALL ClientManagerForm2_uidata.ClientManagerForm2_uidata_record1_checkRowConcurrentAccess(m_record1_arrRecDB[m_record1_keyIndex].*) RETURNING errNo, errMsg

        WHEN C_ACTION_DELETE --Delete the row in the database
            CALL ClientManagerForm2_uidata.ClientManagerForm2_uidata_record1_deleteRowWithConcurrentAccess(m_record1_arrRecDB[m_record1_keyIndex].*) RETURNING errNo, errMsg
        OTHERWISE
         -- unexpected error
    END CASE
...
FUNCTION ClientManagerForm2_uidialog_record1_synchronizeUI(p_dialog, p_state, p_internalAction, p_rec_br_uk)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
    ...
    WHILE l_continue
        ...
        CASE l_internalAction
            WHEN C_INTERNAL_ACTION_SUCCESS
                ...
                END IF
                CALL ClientManagerForm2_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo --Done to update the m_record1_arrRecDB
            ...
            WHEN C_INTERNAL_ACTION_REFRESH_CURRENT_ROW
                CALL ClientManagerForm2_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo
                IF errNo == ERROR_NOTFOUND THEN
                    LET l_internalAction = C_INTERNAL_ACTION_DELETE_DATA
                    LET l_continue = TRUE
                    CONTINUE WHILE
            ...
            WHEN C_INTERNAL_ACTION_REFRESH_ALL_ROWS
                CALL ClientManagerForm2_uidialogdata_record1_fetchAll(m_where, m_detailList)
    ...
    IF p_state != C_MODE_DISPLAY THEN
        ...
        CALL ClientManagerForm2_uidialog_record1_setFieldActive(p_dialog, p_state)
    END IF

    CALL ClientManagerForm2_uidialog_record1_setActionStates(p_dialog, p_state)
    IF NOT libdbapp_isMobile() THEN
        MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
    END IF
...
FUNCTION ClientManagerForm2_uidialog_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    ...
    IF ClientManagerForm2_events.m_DlgEvent_OnActionStatesChange IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
#+ @param p_dialog      The current DIALOG
#+ @param p_mode        The current mode
FUNCTION ClientManagerForm2_uidialog_record1_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    DEFINE p_mode SMALLINT
    {<POINT Name="fct.record1_setActionStates.define">} {</POINT>}

    --Sets the state of the DIALOG actions
    CALL ClientManagerForm2_uidialog_setActionStates(p_dialog, p_mode)
    ...
    IF ClientManagerForm2_events.m_DlgEvent_record1_OnActionStatesChange IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_record1_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
PUBLIC FUNCTION ClientManagerForm2_uidialog_record1_setFieldActive(p_dialog, p_state)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
    ...
    IF ClientManagerForm2_events.m_DlgEvent_record1_OnFieldsActivation IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_record1_OnFieldsActivation(p_dialog, p_state)
    END IF
END FUNCTION
...
#+
#+ @param p_dialog The current DIALOG
PUBLIC FUNCTION ClientManagerForm2_uidialog_setAllCurrentRow(p_dialog)
    DEFINE p_dialog ui.Dialog
