{<CODEFILE Path="PreferenceControlManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL PreferenceControlManager_install()

    CONNECT TO "consultcompanion"

    CALL PreferenceControlManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION PreferenceControlManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION PreferenceControlManager_openFirstForm()
    ...
    CALL PreferencesForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
