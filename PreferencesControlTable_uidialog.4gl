{<CODEFILE Path="PreferencesControlTable.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
...
IMPORT FGL PreferencesControlTable_common
IMPORT FGL PreferencesControlTable
IMPORT FGL PreferencesControlTable_events
IMPORT FGL PreferencesControlTable_uidata
IMPORT FGL PreferencesControlTable_uidialogdata
...
DIALOG PreferencesControlTable_uidialog_record1_uiDisplay()
    ...
    DISPLAY ARRAY m_record1_arrRecGrid TO record1.* ATTRIBUTES(COUNT=IIF(m_record1_arrKeyRec.getLength() <= 0, 1, m_record1_arrKeyRec.getLength()))
        BEFORE DISPLAY
            ...
            CALL PreferencesControlTable_uidialog_record1_setActionStates(DIALOG, C_MODE_DISPLAY)
            ...
            INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
            IF PreferencesControlTable_events.m_DlgEvent_record1_BeforeDisplay IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_BeforeDisplay(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF

            CASE PreferencesControlTable_events.m_DlgCtrlInstruction
        ...
        BEFORE ROW
            ...
            IF (m_record1_keyIndex != DIALOG.getCurrentRow("record1") OR m_prevAction == C_ACTION_CANCEL) THEN
                ...
                CALL PreferencesControlTable_uidialog_record1_validateCRUDOperation(DIALOG, m_state, C_ACTION_REFRESH_CURRENT_ROW) RETURNING l_internalAction
            END IF
            CALL PreferencesControlTable_uidialog_setAllCurrentRow(DIALOG)
            IF m_record1_arrKeyRec.getLength() > 1 THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrKeyRec.getLength()
            END IF

            INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
            IF PreferencesControlTable_events.m_DlgEvent_record1_BeforeRow IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_BeforeRow(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION append
            ...
            LET PreferencesControlTable_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF PreferencesControlTable_events.m_DlgEvent_record1_OnActionAppend IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_OnActionAppend(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION update
            ...
            LET PreferencesControlTable_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF PreferencesControlTable_events.m_DlgEvent_record1_OnActionUpdate IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_OnActionUpdate(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --DISPLAY (record1)
            ...
            CALL PreferencesControlTable_uidialog_record1_validateCRUDOperation(DIALOG, m_state, C_ACTION_DELETE) RETURNING l_internalAction
            ...
            INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
            IF PreferencesControlTable_events.m_DlgEvent_record1_OnActionDelete IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_OnActionDelete(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER DISPLAY
        INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
        IF PreferencesControlTable_events.m_DlgEvent_record1_AfterDisplay IS NOT NULL THEN
            CALL PreferencesControlTable_events.m_DlgEvent_record1_AfterDisplay(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER ROW
        INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
        IF PreferencesControlTable_events.m_DlgEvent_record1_AfterRow IS NOT NULL THEN
            CALL PreferencesControlTable_events.m_DlgEvent_record1_AfterRow(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
        END IF
...
DIALOG PreferencesControlTable_uidialog_record1_uiInput()
    DEFINE l_internalAction SMALLINT
    DEFINE errNo INTEGER

    {<POINT Name="dlg.record1.uiInput.define">} {</POINT>}

    INPUT m_record1_arrRecGrid[1].preferences_seqid
    FROM  preferences.seqid
    ATTRIBUTES(WITHOUT DEFAULTS = TRUE)
        BEFORE INPUT
            ...
            IF m_navigation_direction != 0 THEN
                CALL PreferencesControlTable_uidialog_record1_navigate(DIALOG,C_MODE_MODIFY,m_navigation_direction)
            ...
            IF initializeUI THEN
                CALL PreferencesControlTable_uidialog_record1_setFieldActive(DIALOG, m_state)
            ...
            IF m_state == C_MODE_ADD THEN
                CALL PreferencesControlTable_uidialog_record1_navigate(DIALOG, C_MODE_ADD, 3)
                CALL PreferencesControlTable_uidialogdata_record1_setDefaultValues(DIALOG)
                CALL PreferencesControlTable_uidialogdata_record1_fetchDetails()
            END IF
            CALL PreferencesControlTable_uidialog_record1_setFieldActive(DIALOG, m_state)
            CALL PreferencesControlTable_uidialog_record1_setActionStates(DIALOG, m_state)
            CALL PreferencesControlTable_uidialog_setAllCurrentRow(DIALOG)
            IF m_record1_arrKeyRec.getLength() > 1 THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrKeyRec.getLength()
            END IF
            ...
            INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
            IF PreferencesControlTable_events.m_DlgEvent_record1_BeforeInput IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_BeforeInput(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER INPUT
            ...
            CALL PreferencesControlTable_uidialog_record1_validateCRUDOperation(DIALOG, m_state, m_actionNo) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
            ...
            IF m_dataProcessing THEN --Skip the DVM validation because a data processing is in progress in an other subdialog
                LET PreferencesControlTable_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            ELSE
                INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
            END IF
            IF PreferencesControlTable_events.m_DlgEvent_record1_AfterInput IS NOT NULL THEN
                CALL PreferencesControlTable_events.m_DlgEvent_record1_AfterInput(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                    RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --MODIFY (record1)
            ...
            CALL PreferencesControlTable_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DELETE) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                    CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                    LET m_dataProcessing = FALSE
        ...
        ON ACTION dialogtouched --INPUT (record1)
            ...
            IF m_state == C_MODE_MODIFY THEN
                CALL PreferencesControlTable_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DIALOGTOUCHED) RETURNING l_internalAction
                CASE l_internalAction
                    WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                        CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                        CONTINUE DIALOG
...
DIALOG PreferencesControlTable_uidialog_record1_uiConstruct()

    {<POINT Name="dlg.record1.uiConstruct.define">} {</POINT>}

    CONSTRUCT m_record1_where
                 ON preferences.seqid
             FROM preferences.seqid

        BEFORE CONSTRUCT
        INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
        IF PreferencesControlTable_events.m_DlgEvent_record1_BeforeConstruct IS NOT NULL THEN
            CALL PreferencesControlTable_events.m_DlgEvent_record1_BeforeConstruct(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER CONSTRUCT
        INITIALIZE PreferencesControlTable_events.m_DlgCtrlInstruction TO NULL
        IF PreferencesControlTable_events.m_DlgEvent_record1_AfterConstruct IS NOT NULL THEN
            CALL PreferencesControlTable_events.m_DlgEvent_record1_AfterConstruct(DIALOG, m_state, PreferencesControlTable_events.m_DlgCtrlInstruction)
                RETURNING PreferencesControlTable_events.m_DlgCtrlInstruction
        END IF
...
FUNCTION PreferencesControlTable_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
    ...
    IF l_internalAction == C_INTERNAL_ACTION_PROCESS_OPERATION THEN
        ...
        IF l_action != C_ACTION_DELETE AND l_action != C_ACTION_DIALOGTOUCHED THEN
            ...
            END IF
        END IF
        CALL PreferencesControlTable_uidialog_record1_processCRUDOperation(l_action) RETURNING l_internalAction, l_rec_br_uk.*
    END IF
    IF l_internalAction != C_INTERNAL_ACTION_NEXT_FIELD_CURRENT AND l_internalAction != C_INTERNAL_EXIT_DIALOG THEN
        ...
        IF l_internalAction != C_INTERNAL_ACTION_NO_SYNC THEN
            CALL PreferencesControlTable_uidialog_record1_synchronizeUI(p_dialog, p_state, l_internalAction, l_rec_br_uk.*) RETURNING m_copy_record1.*
        END IF
...
FUNCTION PreferencesControlTable_uidialog_record1_processCRUDOperation(p_action)
    DEFINE p_action SMALLINT
    DEFINE l_internalAction SMALLINT
    DEFINE l_rec_br_uk record1_br_uk_type --key returned by INSERT operation
    DEFINE errNo INTEGER
    ...
    CASE p_action
        WHEN C_ACTION_APPEND --Insert the row in the database
            CALL PreferencesControlTable_uidata.PreferencesControlTable_uidata_record1_insertRow(m_record1_arrRecGrid[1].*) RETURNING errNo, errMsg, l_rec_br_uk.*
        WHEN C_ACTION_UPDATE --Update the row in the database
            CALL PreferencesControlTable_uidata.PreferencesControlTable_uidata_record1_updateRow(m_record1_arrRecGrid[1].*, m_record1_arrRecDB[1].*) RETURNING errNo, errMsg
        WHEN C_ACTION_DIALOGTOUCHED --Check the row in the database
            CALL PreferencesControlTable_uidata.PreferencesControlTable_uidata_record1_checkRowConcurrentAccess(m_record1_arrRecDB[1].*) RETURNING errNo, errMsg

        WHEN C_ACTION_DELETE --Delete the row in the database
            CALL PreferencesControlTable_uidata.PreferencesControlTable_uidata_record1_deleteRowWithConcurrentAccess(m_record1_arrRecDB[1].*) RETURNING errNo, errMsg
        OTHERWISE
         -- unexpected error
    END CASE
...
FUNCTION PreferencesControlTable_uidialog_record1_synchronizeUI(p_dialog, p_state, p_internalAction, p_rec_br_uk)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
        ...
        CASE l_internalAction
            WHEN C_INTERNAL_ACTION_SUCCESS
                IF p_state == C_MODE_ADD THEN
                    ...
                    LET m_record1_arrRecGrid[1].preferences_seqid = p_rec_br_uk.preferences_seqid --Refresh the inserted key value in the UI (may be a composite key) (Useful in the case of SERIALS which are known after the INSERT sql statement)
                END IF
                CALL PreferencesControlTable_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo --Done to update the m_record1_arrRecDB
            ...
            WHEN C_INTERNAL_ACTION_REFRESH_CURRENT_ROW
                CALL PreferencesControlTable_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo
                IF errNo == ERROR_NOTFOUND THEN
                    LET l_internalAction = C_INTERNAL_ACTION_DELETE_DATA
                    LET l_continue = TRUE
                    CONTINUE WHILE
            ...
            WHEN C_INTERNAL_ACTION_REFRESH_ALL_ROWS
                CALL PreferencesControlTable_uidialogdata_record1_fetchAll(m_where, m_detailList)
            ...
            WHEN C_INTERNAL_ACTION_RESTORE_DATA
                ...
                IF p_state == C_MODE_ADD THEN
                    ...
                    CALL PreferencesControlTable_uidialog_record1_validateCRUDOperation(p_dialog, p_state, C_ACTION_REFRESH_CURRENT_ROW) RETURNING l_internalAction
                END IF
    ...
    IF p_state != C_MODE_DISPLAY THEN
        ...
        CALL PreferencesControlTable_uidialog_record1_setFieldActive(p_dialog, p_state)
    END IF
    IF p_state == C_MODE_DISPLAY THEN
        CALL p_dialog.setArrayLength("record1", m_record1_arrKeyRec.getLength())
    END IF

    CALL PreferencesControlTable_uidialog_record1_setActionStates(p_dialog, p_state)
    IF m_record1_arrKeyRec.getLength() > 1 THEN
        MESSAGE m_record1_keyIndex, "/", m_record1_arrKeyRec.getLength()
    END IF
    LET m_copy_record1.* = m_record1_arrRecGrid[1].* --Keep a local copy
...
FUNCTION PreferencesControlTable_uidialog_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    ...
    IF PreferencesControlTable_events.m_DlgEvent_OnActionStatesChange IS NOT NULL THEN
        CALL PreferencesControlTable_events.m_DlgEvent_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
#+ @param p_dialog      The current DIALOG
#+ @param p_mode        The current mode
FUNCTION PreferencesControlTable_uidialog_record1_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    DEFINE p_mode SMALLINT
    {<POINT Name="fct.record1_setActionStates.define">} {</POINT>}

    --Sets the state of the DIALOG actions
    CALL PreferencesControlTable_uidialog_setActionStates(p_dialog, p_mode)
    ...
    IF PreferencesControlTable_events.m_DlgEvent_record1_OnActionStatesChange IS NOT NULL THEN
        CALL PreferencesControlTable_events.m_DlgEvent_record1_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
PUBLIC FUNCTION PreferencesControlTable_uidialog_record1_setFieldActive(p_dialog, p_state)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
    {<POINT Name="fct.record1_setFieldActive.define">} {</POINT>}
    {<POINT Name="fct.record1_setFieldActive.init">} {</POINT>}

    CALL p_dialog.setFieldActive("preferences.seqid", p_state == C_MODE_ADD)

    {<POINT Name="fct.record1_setFieldActive.user">} {</POINT>}
    IF PreferencesControlTable_events.m_DlgEvent_record1_OnFieldsActivation IS NOT NULL THEN
        CALL PreferencesControlTable_events.m_DlgEvent_record1_OnFieldsActivation(p_dialog, p_state)
    END IF
END FUNCTION
...
#+                    3 to add a row
FUNCTION PreferencesControlTable_uidialog_record1_navigate(p_dialog, p_state, p_direction)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
...
#+
#+ @param p_dialog The current DIALOG
PUBLIC FUNCTION PreferencesControlTable_uidialog_setAllCurrentRow(p_dialog)
    DEFINE p_dialog ui.Dialog
