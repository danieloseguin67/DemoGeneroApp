...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE country.*) RETURNS (INTEGER, STRING, RECORD LIKE country.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE country.*, p_dataT1 RECORD LIKE country.*) RETURNS (INTEGER, STRING, RECORD LIKE country.*, RECORD LIKE country.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE country.*) RETURNS (INTEGER, STRING, RECORD LIKE country.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE country.*) RETURNS (INTEGER, STRING)
