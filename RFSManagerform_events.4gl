...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE rfs.*) RETURNS (INTEGER, STRING, RECORD LIKE rfs.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE rfs.*, p_dataT1 RECORD LIKE rfs.*) RETURNS (INTEGER, STRING, RECORD LIKE rfs.*, RECORD LIKE rfs.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE rfs.*) RETURNS (INTEGER, STRING, RECORD LIKE rfs.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE rfs.*) RETURNS (INTEGER, STRING)
...
PUBLIC DEFINE m_DlgEvent__action_zm_offerstastus_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_offerstastus_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_stakeholder_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_stakeholder_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_client_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_client_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
