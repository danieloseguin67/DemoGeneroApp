...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE clienttypes.*) RETURNS (INTEGER, STRING, RECORD LIKE clienttypes.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE clienttypes.*, p_dataT1 RECORD LIKE clienttypes.*) RETURNS (INTEGER, STRING, RECORD LIKE clienttypes.*, RECORD LIKE clienttypes.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE clienttypes.*) RETURNS (INTEGER, STRING, RECORD LIKE clienttypes.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE clienttypes.*) RETURNS (INTEGER, STRING)
