{<CODEFILE Path="EmployeeManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL EmployeeManager_install()

    CONNECT TO "consultcompanion"

    CALL EmployeeManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION EmployeeManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION EmployeeManager_openFirstForm()
    ...
    CALL EmployeeManagerForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
