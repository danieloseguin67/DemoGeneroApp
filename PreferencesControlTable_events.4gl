...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE preferences.*) RETURNS (INTEGER, STRING, RECORD LIKE preferences.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE preferences.*, p_dataT1 RECORD LIKE preferences.*) RETURNS (INTEGER, STRING, RECORD LIKE preferences.*, RECORD LIKE preferences.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE preferences.*) RETURNS (INTEGER, STRING, RECORD LIKE preferences.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE preferences.*) RETURNS (INTEGER, STRING)
