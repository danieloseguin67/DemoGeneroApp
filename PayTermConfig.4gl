{<CODEFILE Path="PayTermConfig.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL PayTermConfig_install()

    CONNECT TO "consultcompanion"

    CALL PayTermConfig_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION PayTermConfig_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION PayTermConfig_openFirstForm()
    ...
    CALL PayTermConfirmForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
