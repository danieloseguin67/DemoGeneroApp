...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE employees.*) RETURNS (INTEGER, STRING, RECORD LIKE employees.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE employees.*, p_dataT1 RECORD LIKE employees.*) RETURNS (INTEGER, STRING, RECORD LIKE employees.*, RECORD LIKE employees.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE employees.*) RETURNS (INTEGER, STRING, RECORD LIKE employees.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE employees.*) RETURNS (INTEGER, STRING)
...
PUBLIC DEFINE m_DlgEvent__action_zm_emptype_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_emptype_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
