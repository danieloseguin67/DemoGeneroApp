...
IMPORT FGL PayTermZoom_common
IMPORT FGL PayTermZoom
IMPORT FGL PayTermZoom_events
IMPORT FGL PayTermZoom_uidata
IMPORT FGL PayTermZoom_uidialogdata
IMPORT FGL PayTermZoom_uidialog
...
PRIVATE FUNCTION PayTermZoom_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL PayTermZoom_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL PayTermZoom_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL PayTermZoom_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION PayTermZoom_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG PayTermZoom_uidialog.PayTermZoom_uidialog_record1_uiDisplay

        ON ACTION query
            {<POINT Name="fct.uiDisplay.dlg.onAction.query">} {</POINT>}
            LET m_actionNo = C_ACTION_QUERY

            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF PayTermZoom_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF

            CASE PayTermZoom_events.m_DlgCtrlInstruction
        ...
        ON ACTION accept
            ...
            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF PayTermZoom_events.m_DlgEvent_OnActionAccept IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_OnActionAccept(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION cancel
            ...
            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF PayTermZoom_events.m_DlgEvent_OnActionCancel IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_OnActionCancel(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION close
            ...
            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF PayTermZoom_events.m_DlgEvent_OnActionClose IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_OnActionClose(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION exit
            ...
            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF PayTermZoom_events.m_DlgEvent_OnActionExit IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_OnActionExit(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE DIALOG
            ...
            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF PayTermZoom_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            INITIALIZE PayTermZoom_events.m_DlgCtrlInstruction TO NULL
            IF PayTermZoom_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION PayTermZoom_ui_uiConstruct(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG PayTermZoom_uidialog.PayTermZoom_uidialog_record1_uiConstruct
        ...
        BEFORE DIALOG
            ...
            INITIALIZE PayTermZoom_events.m_DlgCtrlInstruction TO NULL
            IF PayTermZoom_events.m_DlgEvent_Before_SearchDialog IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_Before_SearchDialog(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
            CASE PayTermZoom_events.m_DlgCtrlInstruction
                WHEN libdbappEvents.ACCEPT_DIALOG
        ...
        AFTER DIALOG
            ...
            INITIALIZE PayTermZoom_events.m_DlgCtrlInstruction TO NULL
            IF PayTermZoom_events.m_DlgEvent_After_SearchDialog IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_After_SearchDialog(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction, m_where, m_detailList)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction, m_where, m_detailList
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION PayTermZoom_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE PayTermZoom_events.m_DlgCtrlInstruction TO NULL
        IF PayTermZoom_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL PayTermZoom_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                RETURNING PayTermZoom_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION query
            ...
            LET PayTermZoom_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF PayTermZoom_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL PayTermZoom_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, PayTermZoom_events.m_DlgCtrlInstruction)
                    RETURNING PayTermZoom_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION PayTermZoom_ui_uiInitializeDefaultActions(p_actionList)
...
PUBLIC FUNCTION PayTermZoom_ui_initializeDefaultUISettings()
