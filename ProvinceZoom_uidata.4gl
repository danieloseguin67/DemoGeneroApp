{<CODEFILE Path="ProvinceZoom.code" Hash="nt1PUnseG2Lv3QghQvqvIw==" />}
...
PUBLIC FUNCTION ProvinceZoom_uidata_record1_getDataByKey(p_rec_br_uk)
    ...
    WHENEVER ERROR CONTINUE
        SELECT @provinces.provinceid,
            @provinces.provincename,
            @provinces.countryid,
            provinces.*
        INTO l_rec_BRdata.provinces_provinceid,
            l_rec_BRdata.provinces_provincename,
            l_rec_BRdata.provinces_countryid,
            l_rec_DBdata.*
        FROM provinces
