{<CODEFILE Path="OfferStatusConfig.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL OfferStatusConfig_install()

    CONNECT TO "consultcompanion"

    CALL OfferStatusConfig_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION OfferStatusConfig_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION OfferStatusConfig_openFirstForm()
    ...
    CALL OfferStatusConfigForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
