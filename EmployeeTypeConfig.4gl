{<CODEFILE Path="EmployeeTypeConfig.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL EmployeeTypeConfig_install()

    CONNECT TO "consultcompanion"

    CALL EmployeeTypeConfig_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION EmployeeTypeConfig_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION EmployeeTypeConfig_openFirstForm()
    ...
    CALL EmployeeTypeConfigForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
