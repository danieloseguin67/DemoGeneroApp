...
IMPORT FGL ClientManagerForm2_uidialog
...
PUBLIC FUNCTION ClientManagerForm2_ui_uiOpenForm(p_whereRelation, p_uiSettings)
    ...
    CALL ClientManagerForm2_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings.*, l_record1_br_uk.*) RETURNING errNo, actionNo, l_record1_br_uk.*
...
PUBLIC FUNCTION ClientManagerForm2_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings, p_br_uk)
    DEFINE p_whereRelation STRING
    DEFINE p_uiSettings UISettings_Type
    ...
    OPEN WINDOW w_ClientManagerForm2 WITH FORM 'ClientManagerForm2' ATTRIBUTES(STYLE=NVL(l_windowStyle, "main_dbapp"))
    --Initialize UI settings with default form UI settings
    CALL ClientManagerForm2_ui_initializeDefaultUISettings() RETURNING l_defaultUISettings.*
    ...
    IF ClientManagerForm2_events.m_DlgEvent_OnOpenForm IS NOT NULL THEN
        CALL ClientManagerForm2_events.m_DlgEvent_OnOpenForm(w.getForm())
    END IF
    ...
    IF m_uiSettings.openMode != C_MODE_SEARCH AND m_uiSettings.openMode != C_MODE_EMPTY THEN
        ...
        LET m_record1_keyIndex = ClientManagerForm2_uidialogdata_record1_seek(p_br_uk.*)
    END IF
    --Call the UI automaton
    CALL ClientManagerForm2_ui_uiAutomaton(m_uiSettings.*) RETURNING errNo, actionNo
    INITIALIZE l_record1_br_uk.* TO NULL
    ...
    END IF
    CLOSE WINDOW w_ClientManagerForm2
...
PRIVATE FUNCTION ClientManagerForm2_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL ClientManagerForm2_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_MODIFY
                ...
                CALL ClientManagerForm2_ui_uiInput(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL ClientManagerForm2_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL ClientManagerForm2_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION ClientManagerForm2_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG ClientManagerForm2_uidialog.ClientManagerForm2_uidialog_record1_uiDisplay
        ...
        ON ACTION new
            ...
            IF ClientManagerForm2_events.m_DlgEvent_OnActionNew IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionNew(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
        ...
        ON ACTION query
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION accept
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_OnActionAccept IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionAccept(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION cancel
            ...
            IF ClientManagerForm2_events.m_DlgEvent_OnActionCancel IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionCancel(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION close
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_OnActionClose IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionClose(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION exit
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_OnActionExit IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionExit(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE DIALOG
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF ClientManagerForm2_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            ...
            IF ClientManagerForm2_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
...
#+ @return           Error number, 0-success, other-error
#+ @return           The next performed action
FUNCTION ClientManagerForm2_ui_uiInput(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG ClientManagerForm2_uidialog.ClientManagerForm2_uidialog_record1_uiInput
        ...
        ON ACTION cancel
            ...
            CALL ClientManagerForm2_ui_validateCRUDOperationWrapper(DIALOG, m_subdialog, m_state, C_ACTION_CANCEL)
        ...
        AFTER DIALOG
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_After_EditDialog IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_After_EditDialog(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION ClientManagerForm2_ui_uiConstruct(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG ClientManagerForm2_uidialog.ClientManagerForm2_uidialog_record1_uiConstruct
        ...
        BEFORE DIALOG
            ...
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_Before_SearchDialog IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_Before_SearchDialog(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
            CASE ClientManagerForm2_events.m_DlgCtrlInstruction
                WHEN libdbappEvents.ACCEPT_DIALOG
        ...
        AFTER DIALOG
            ...
            INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
            IF ClientManagerForm2_events.m_DlgEvent_After_SearchDialog IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_After_SearchDialog(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction, m_where, m_detailList)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction, m_where, m_detailList
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION ClientManagerForm2_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE ClientManagerForm2_events.m_DlgCtrlInstruction TO NULL
        IF ClientManagerForm2_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL ClientManagerForm2_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION new
            ...
            LET ClientManagerForm2_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF ClientManagerForm2_events.m_DlgEvent_OnActionNew IS NOT NULL THEN
                CALL ClientManagerForm2_events.m_DlgEvent_OnActionNew(DIALOG, m_state, ClientManagerForm2_events.m_DlgCtrlInstruction)
                    RETURNING ClientManagerForm2_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION ClientManagerForm2_ui_uiInitializeDefaultActions(p_actionList)
...
PUBLIC FUNCTION ClientManagerForm2_ui_initializeDefaultUISettings()
...
FUNCTION ClientManagerForm2_ui_validateCRUDOperationWrapper(p_dialog, p_subdialog_name, p_state, p_action)
    ...
    CASE p_subdialog_name
        WHEN "record1"
            CALL ClientManagerForm2_uidialog.ClientManagerForm2_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
                RETURNING l_internalAction
    END CASE
