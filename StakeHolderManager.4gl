{<CODEFILE Path="StakeHolderManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL StakeHolderManager_install()

    CONNECT TO "consultcompanion"

    CALL StakeHolderManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION StakeHolderManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION StakeHolderManager_openFirstForm()
    ...
    CALL StakeHolderManagerForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
