{<CODEFILE Path="RFSManagerform.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
...
IMPORT FGL RFSManagerform_uidata
IMPORT FGL RFSManagerform_uidialogdata
...
DIALOG RFSManagerform_uidialog_record1_uiDisplay()
    ...
    DISPLAY ARRAY m_record1_arrRecList TO record1.*
        ...
        BEFORE DISPLAY
            ...
            CALL RFSManagerform_uidialog_record1_setActionStates(DIALOG, C_MODE_DISPLAY)
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeDisplay IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeDisplay(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF

            CASE RFSManagerform_events.m_DlgCtrlInstruction
        ...
        BEFORE ROW
            ...
            IF (m_record1_keyIndex != DIALOG.getCurrentRow("record1") OR m_prevAction == C_ACTION_CANCEL) THEN
                ...
                CALL RFSManagerform_uidialogdata_record1_fetchDetails()
            END IF
            CALL RFSManagerform_uidialog_setAllCurrentRow(DIALOG)
            IF NOT libdbapp_isMobile() THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
            END IF

            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeRow IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeRow(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION append
            ...
            LET RFSManagerform_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF RFSManagerform_events.m_DlgEvent_record1_OnActionAppend IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_OnActionAppend(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION insert
            ...
            LET RFSManagerform_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF RFSManagerform_events.m_DlgEvent_record1_OnActionInsert IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_OnActionInsert(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION update
            ...
            LET RFSManagerform_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF RFSManagerform_events.m_DlgEvent_record1_OnActionUpdate IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_OnActionUpdate(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --DISPLAY (record1)
            ...
            CALL RFSManagerform_uidialog_record1_validateCRUDOperation(DIALOG, m_state, C_ACTION_DELETE) RETURNING l_internalAction
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_OnActionDelete IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_OnActionDelete(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER DISPLAY
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
        IF RFSManagerform_events.m_DlgEvent_record1_AfterDisplay IS NOT NULL THEN
            CALL RFSManagerform_events.m_DlgEvent_record1_AfterDisplay(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                RETURNING RFSManagerform_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER ROW
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
        IF RFSManagerform_events.m_DlgEvent_record1_AfterRow IS NOT NULL THEN
            CALL RFSManagerform_events.m_DlgEvent_record1_AfterRow(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                RETURNING RFSManagerform_events.m_DlgCtrlInstruction
        END IF
...
DIALOG RFSManagerform_uidialog_record1_uiInput()
    DEFINE l_internalAction SMALLINT
    ...
    ATTRIBUTES(WITHOUT DEFAULTS = TRUE, APPEND ROW = TRUE, INSERT ROW = TRUE, DELETE ROW = TRUE)
        BEFORE INPUT
            ...
            IF m_state == C_MODE_ADD THEN
                ...
                END IF
                CALL RFSManagerform_uidialogdata_record1_setDefaultValues(DIALOG)
                CALL RFSManagerform_uidialogdata_record1_fetchDetails()
            END IF
            CALL RFSManagerform_uidialog_record1_setFieldActive(DIALOG, m_state)
            CALL RFSManagerform_uidialog_record1_setActionStates(DIALOG, m_state)
            CALL RFSManagerform_uidialog_setAllCurrentRow(DIALOG)
            IF NOT libdbapp_isMobile() THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeInput IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeInput(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER INPUT
            ...
            IF m_dataProcessing THEN --Skip the DVM validation because a data processing is in progress in an other subdialog
                LET RFSManagerform_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            ELSE
                INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            END IF
            IF RFSManagerform_events.m_DlgEvent_record1_AfterInput IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterInput(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER ROW
            ...
            CALL RFSManagerform_uidialog_record1_validateCRUDOperation(DIALOG, m_state, m_actionNo) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
        ...
        BEFORE INSERT
            ...
            CALL RFSManagerform_uidialogdata_record1_setDefaultValues(DIALOG)
            CALL RFSManagerform_uidialogdata_record1_fetchDetails()
            CALL RFSManagerform_uidialog_record1_setFieldActive(DIALOG, C_MODE_ADD)
            CALL RFSManagerform_uidialog_record1_setActionStates(DIALOG, C_MODE_ADD)
            CALL RFSManagerform_uidialog_setAllCurrentRow(DIALOG)
            IF NOT libdbapp_isMobile() THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeInsert IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeInsert(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --MODIFY (record1)
            ...
            CALL RFSManagerform_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DELETE) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                    CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                    LET m_dataProcessing = FALSE
        ...
        BEFORE FIELD record1.clientid
            {<POINT Name="dlg.record1.uiInput.beforeField.record1.clientid">} {</POINT>}
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "record1.clientid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE FIELD record1.stakeholderId
            {<POINT Name="dlg.record1.uiInput.beforeField.record1.stakeholderId">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', TRUE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', FALSE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "record1.stakeholderId")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE FIELD record1.offerstatusid
            {<POINT Name="dlg.record1.uiInput.beforeField.record1.offerstatusid">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', TRUE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', FALSE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "record1.offerstatusid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER FIELD record1.clientid
            {<POINT Name="dlg.record1.uiInput.afterField.record1.clientid">} {</POINT>}
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_AfterField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "record1.clientid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER FIELD record1.stakeholderId
            {<POINT Name="dlg.record1.uiInput.afterField.record1.stakeholderId">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', FALSE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', TRUE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_AfterField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "record1.stakeholderId")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER FIELD record1.offerstatusid
            {<POINT Name="dlg.record1.uiInput.afterField.record1.offerstatusid">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', FALSE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', TRUE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_AfterField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "record1.offerstatusid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION dialogtouched --INPUT (record1)
            ...
            IF m_state == C_MODE_MODIFY THEN
                CALL RFSManagerform_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DIALOGTOUCHED) RETURNING l_internalAction
                CASE l_internalAction
                    WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                        CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                        CONTINUE DIALOG
        ...
        AFTER INSERT
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
    IF RFSManagerform_events.m_DlgEvent_record1_AfterInsert IS NOT NULL THEN
        CALL RFSManagerform_events.m_DlgEvent_record1_AfterInsert(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
            RETURNING RFSManagerform_events.m_DlgCtrlInstruction
    END IF
    ...
    END CASE
        ...
        BEFORE DELETE
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
    IF RFSManagerform_events.m_DlgEvent_record1_BeforeDelete IS NOT NULL THEN
        CALL RFSManagerform_events.m_DlgEvent_record1_BeforeDelete(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
            RETURNING RFSManagerform_events.m_DlgCtrlInstruction
    END IF
    ...
    END CASE
        ...
        AFTER DELETE
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
    IF RFSManagerform_events.m_DlgEvent_record1_AfterDelete IS NOT NULL THEN
        CALL RFSManagerform_events.m_DlgEvent_record1_AfterDelete(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
            RETURNING RFSManagerform_events.m_DlgCtrlInstruction
    END IF
...
DIALOG RFSManagerform_uidialog_record1_uiConstruct()
    ...
    CONSTRUCT m_record1_where
             ...
             FROM rfs.rfsId,
                    ...
                    rfs.offernote,
                    rfs.accepteddate
        BEFORE FIELD rfs.clientid
            {<POINT Name="dlg.record1.uiConstruct.beforeField.rfs.clientid">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', TRUE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', FALSE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "rfs.clientid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE FIELD rfs.stakeholderId
            {<POINT Name="dlg.record1.uiConstruct.beforeField.rfs.stakeholderId">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', TRUE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', FALSE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "rfs.stakeholderId")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE FIELD rfs.offerstatusid
            {<POINT Name="dlg.record1.uiConstruct.beforeField.rfs.offerstatusid">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', TRUE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', FALSE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_BeforeField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_BeforeField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "rfs.offerstatusid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER FIELD rfs.clientid
            {<POINT Name="dlg.record1.uiConstruct.afterField.rfs.clientid">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', FALSE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', TRUE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_AfterField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "rfs.clientid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER FIELD rfs.stakeholderId
            {<POINT Name="dlg.record1.uiConstruct.afterField.rfs.stakeholderId">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', FALSE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', TRUE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_AfterField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "rfs.stakeholderId")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER FIELD rfs.offerstatusid
            {<POINT Name="dlg.record1.uiConstruct.afterField.rfs.offerstatusid">} {</POINT>}
            CALL DIALOG.setActionActive('zoom', FALSE)
            IF libdbapp_isMobile() THEN
                CALL DIALOG.setActionHidden('zoom', TRUE)
            END IF
            ...
            INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
            IF RFSManagerform_events.m_DlgEvent_record1_AfterField IS NOT NULL THEN
                CALL RFSManagerform_events.m_DlgEvent_record1_AfterField(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction, "rfs.offerstatusid")
                    RETURNING RFSManagerform_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE CONSTRUCT
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
        IF RFSManagerform_events.m_DlgEvent_record1_BeforeConstruct IS NOT NULL THEN
            CALL RFSManagerform_events.m_DlgEvent_record1_BeforeConstruct(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                RETURNING RFSManagerform_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER CONSTRUCT
        INITIALIZE RFSManagerform_events.m_DlgCtrlInstruction TO NULL
        IF RFSManagerform_events.m_DlgEvent_record1_AfterConstruct IS NOT NULL THEN
            CALL RFSManagerform_events.m_DlgEvent_record1_AfterConstruct(DIALOG, m_state, RFSManagerform_events.m_DlgCtrlInstruction)
                RETURNING RFSManagerform_events.m_DlgCtrlInstruction
        END IF
...
FUNCTION RFSManagerform_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
    ...
    IF l_internalAction == C_INTERNAL_ACTION_PROCESS_OPERATION THEN
        ...
        IF l_action != C_ACTION_DELETE AND l_action != C_ACTION_DIALOGTOUCHED THEN
            ...
            END IF
        END IF
        CALL RFSManagerform_uidialog_record1_processCRUDOperation(l_action) RETURNING l_internalAction, l_rec_br_uk.*
    END IF
    IF l_internalAction != C_INTERNAL_ACTION_NEXT_FIELD_CURRENT AND l_internalAction != C_INTERNAL_EXIT_DIALOG THEN
        ...
        IF l_internalAction != C_INTERNAL_ACTION_NO_SYNC THEN
            CALL RFSManagerform_uidialog_record1_synchronizeUI(p_dialog, p_state, l_internalAction, l_rec_br_uk.*) RETURNING m_copy_record1.*
        END IF
...
FUNCTION RFSManagerform_uidialog_record1_processCRUDOperation(p_action)
    DEFINE p_action SMALLINT
    DEFINE l_internalAction SMALLINT
    DEFINE l_rec_br_uk record1_br_uk_type --key returned by INSERT operation
    DEFINE errNo INTEGER
    ...
    CASE p_action
        WHEN C_ACTION_APPEND --Insert the row in the database
            CALL RFSManagerform_uidata.RFSManagerform_uidata_record1_insertRow(m_record1_arrRecList[m_record1_keyIndex].*) RETURNING errNo, errMsg, l_rec_br_uk.*
        WHEN C_ACTION_UPDATE --Update the row in the database
            CALL RFSManagerform_uidata.RFSManagerform_uidata_record1_updateRow(m_record1_arrRecList[m_record1_keyIndex].*, m_record1_arrRecDB[m_record1_keyIndex].*) RETURNING errNo, errMsg
        WHEN C_ACTION_DIALOGTOUCHED --Check the row in the database
            CALL RFSManagerform_uidata.RFSManagerform_uidata_record1_checkRowConcurrentAccess(m_record1_arrRecDB[m_record1_keyIndex].*) RETURNING errNo, errMsg

        WHEN C_ACTION_DELETE --Delete the row in the database
            CALL RFSManagerform_uidata.RFSManagerform_uidata_record1_deleteRowWithConcurrentAccess(m_record1_arrRecDB[m_record1_keyIndex].*) RETURNING errNo, errMsg
        OTHERWISE
         -- unexpected error
    END CASE
...
FUNCTION RFSManagerform_uidialog_record1_synchronizeUI(p_dialog, p_state, p_internalAction, p_rec_br_uk)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
        ...
        CASE l_internalAction
            WHEN C_INTERNAL_ACTION_SUCCESS
                IF p_state == C_MODE_ADD THEN
                    ...
                    LET m_record1_arrRecList[m_record1_keyIndex].rfs_rfsId = p_rec_br_uk.rfs_rfsId --Refresh the inserted key value in the UI (may be a composite key) (Useful in the case of SERIALS which are known after the INSERT sql statement)
                END IF
                CALL RFSManagerform_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo --Done to update the m_record1_arrRecDB
            ...
            WHEN C_INTERNAL_ACTION_REFRESH_CURRENT_ROW
                CALL RFSManagerform_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo
                IF errNo == ERROR_NOTFOUND THEN
                    LET l_internalAction = C_INTERNAL_ACTION_DELETE_DATA
                    LET l_continue = TRUE
                    CONTINUE WHILE
            ...
            WHEN C_INTERNAL_ACTION_REFRESH_ALL_ROWS
                CALL RFSManagerform_uidialogdata_record1_fetchAll(m_where, m_detailList)
    ...
    IF p_state != C_MODE_DISPLAY THEN
        ...
        CALL RFSManagerform_uidialog_record1_setFieldActive(p_dialog, p_state)
    END IF

    CALL RFSManagerform_uidialog_record1_setActionStates(p_dialog, p_state)
    IF NOT libdbapp_isMobile() THEN
        MESSAGE m_record1_keyIndex, "/", m_record1_arrRecList.getLength()
    END IF
...
FUNCTION RFSManagerform_uidialog_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    ...
    IF RFSManagerform_events.m_DlgEvent_OnActionStatesChange IS NOT NULL THEN
        CALL RFSManagerform_events.m_DlgEvent_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
#+ @param p_dialog      The current DIALOG
#+ @param p_mode        The current mode
FUNCTION RFSManagerform_uidialog_record1_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    DEFINE p_mode SMALLINT
    {<POINT Name="fct.record1_setActionStates.define">} {</POINT>}

    --Sets the state of the DIALOG actions
    CALL RFSManagerform_uidialog_setActionStates(p_dialog, p_mode)
    ...
    IF RFSManagerform_events.m_DlgEvent_record1_OnActionStatesChange IS NOT NULL THEN
        CALL RFSManagerform_events.m_DlgEvent_record1_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
PUBLIC FUNCTION RFSManagerform_uidialog_record1_setFieldActive(p_dialog, p_state)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
    ...
    IF RFSManagerform_events.m_DlgEvent_record1_OnFieldsActivation IS NOT NULL THEN
        CALL RFSManagerform_events.m_DlgEvent_record1_OnFieldsActivation(p_dialog, p_state)
    END IF
END FUNCTION
...
#+
#+ @param p_dialog The current DIALOG
PUBLIC FUNCTION RFSManagerform_uidialog_setAllCurrentRow(p_dialog)
    DEFINE p_dialog ui.Dialog
