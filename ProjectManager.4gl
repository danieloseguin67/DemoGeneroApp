{<CODEFILE Path="ProjectManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL ProjectManager_install()

    CONNECT TO "consultcompanion"

    CALL ProjectManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION ProjectManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION ProjectManager_openFirstForm()
    ...
    CALL ProjectManagerForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
