...
IMPORT FGL StakeHolderManagerForm_uidialog
...
PUBLIC FUNCTION StakeHolderManagerForm_ui_uiOpenForm(p_whereRelation, p_uiSettings)
    ...
    CALL StakeHolderManagerForm_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings.*, l_record1_br_uk.*) RETURNING errNo, actionNo, l_record1_br_uk.*
...
PUBLIC FUNCTION StakeHolderManagerForm_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings, p_br_uk)
    DEFINE p_whereRelation STRING
    DEFINE p_uiSettings UISettings_Type
    ...
    OPEN WINDOW w_StakeHolderManagerForm WITH FORM 'StakeHolderManagerForm' ATTRIBUTES(STYLE=NVL(l_windowStyle, "main_dbapp"))
    --Initialize UI settings with default form UI settings
    CALL StakeHolderManagerForm_ui_initializeDefaultUISettings() RETURNING l_defaultUISettings.*
    ...
    CALL StakeHolderManagerForm_events.registerDlgEvents()
    CALL consultcompanion_events.registerDbxEvents()

    --Load actions in the ToolBar and the TopMenu
    IF NOT libdbapp_isMobile() THEN
        CALL StakeHolderManagerForm_ui_uiInitializeDefaultActions(l_actionList)
    ...
    IF StakeHolderManagerForm_events.m_DlgEvent_OnOpenForm IS NOT NULL THEN
        CALL StakeHolderManagerForm_events.m_DlgEvent_OnOpenForm(w.getForm())
    END IF
    ...
    IF m_uiSettings.openMode != C_MODE_SEARCH AND m_uiSettings.openMode != C_MODE_EMPTY THEN
        ...
        LET m_record1_keyIndex = StakeHolderManagerForm_uidialogdata_record1_seek(p_br_uk.*)
        CALL StakeHolderManagerForm_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo
    END IF
    --Call the UI automaton
    CALL StakeHolderManagerForm_ui_uiAutomaton(m_uiSettings.*) RETURNING errNo, actionNo
    INITIALIZE l_record1_br_uk.* TO NULL
    IF m_record1_keyIndex > 0 THEN
        LET l_record1_br_uk.clientstakeholders_stakeholderId = m_record1_arrKeyRec[m_record1_keyIndex].clientstakeholders_stakeholderId
    END IF
    CLOSE WINDOW w_StakeHolderManagerForm
...
PRIVATE FUNCTION StakeHolderManagerForm_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL StakeHolderManagerForm_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_MODIFY
                ...
                CALL StakeHolderManagerForm_ui_uiInput(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL StakeHolderManagerForm_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL StakeHolderManagerForm_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION StakeHolderManagerForm_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG StakeHolderManagerForm_uidialog.StakeHolderManagerForm_uidialog_record1_uiDisplay
        ...
        ON ACTION new
            ...
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionNew IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionNew(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
        ...
        ON ACTION query
            ...
            LET StakeHolderManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION accept
            ...
            LET StakeHolderManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionAccept IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionAccept(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION cancel
            ...
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionCancel IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionCancel(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION close
            ...
            LET StakeHolderManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionClose IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionClose(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION exit
            ...
            LET StakeHolderManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionExit IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionExit(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE DIALOG
            ...
            LET StakeHolderManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF StakeHolderManagerForm_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            ...
            IF StakeHolderManagerForm_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
...
#+ @return           Error number, 0-success, other-error
#+ @return           The next performed action
FUNCTION StakeHolderManagerForm_ui_uiInput(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG StakeHolderManagerForm_uidialog.StakeHolderManagerForm_uidialog_record1_uiInput

        ON ACTION zm_client
            {<POINT Name="fct.uiInput.dlg.onAction.zm_client">} {</POINT>}
            CALL StakeHolderManagerForm_ui_action_zm_client() RETURNING errNo, actionNo, l_br_uk_zm_client.*
            IF errNo == ERROR_SUCCESS THEN
                ...
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    IF (m_record1_arrRecGrid[1].clientstakeholders_clientId IS NULL) OR (m_record1_arrRecGrid[1].clientstakeholders_clientId != l_br_uk_zm_client.clientstakeholders_clientId) THEN
                        CALL DIALOG.setFieldTouched("clientstakeholders.clientId", TRUE)
                        LET m_record1_arrRecGrid[1].clientstakeholders_clientId = l_br_uk_zm_client.clientstakeholders_clientId
        ...
        ON ACTION zoom
            ...
            IF INFIELD(clientstakeholders.clientId) THEN
                CALL StakeHolderManagerForm_ui_action_zm_client() RETURNING errNo, actionNo, l_br_uk_zm_client.*
                IF errNo == ERROR_SUCCESS THEN
                    IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                        LET m_actionNo = C_ACTION_EXIT_APP
        ...
        ON ACTION cancel
            ...
            CALL StakeHolderManagerForm_ui_validateCRUDOperationWrapper(DIALOG, m_subdialog, m_state, C_ACTION_CANCEL)
        ...
        AFTER DIALOG
            INITIALIZE StakeHolderManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF StakeHolderManagerForm_events.m_DlgEvent_After_EditDialog IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_After_EditDialog(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION StakeHolderManagerForm_ui_uiConstruct(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG StakeHolderManagerForm_uidialog.StakeHolderManagerForm_uidialog_record1_uiConstruct
        ...
        ON ACTION zm_client
            ...
            IF errNo == ERROR_SUCCESS THEN
                ...
                END IF
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    DISPLAY l_br_uk_zm_client.clientstakeholders_clientId TO clientstakeholders.clientId
                END IF
            ELSE
                MESSAGE "Error on the zoom"
            END IF
        ...
        BEFORE DIALOG
            ...
            INITIALIZE StakeHolderManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF StakeHolderManagerForm_events.m_DlgEvent_Before_SearchDialog IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_Before_SearchDialog(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
            CASE StakeHolderManagerForm_events.m_DlgCtrlInstruction
                WHEN libdbappEvents.ACCEPT_DIALOG
        ...
        AFTER DIALOG
            ...
            INITIALIZE StakeHolderManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF StakeHolderManagerForm_events.m_DlgEvent_After_SearchDialog IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_After_SearchDialog(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction, m_where, m_detailList)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction, m_where, m_detailList
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION StakeHolderManagerForm_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE StakeHolderManagerForm_events.m_DlgCtrlInstruction TO NULL
        IF StakeHolderManagerForm_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL StakeHolderManagerForm_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION new
            ...
            LET StakeHolderManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF StakeHolderManagerForm_events.m_DlgEvent_OnActionNew IS NOT NULL THEN
                CALL StakeHolderManagerForm_events.m_DlgEvent_OnActionNew(DIALOG, m_state, StakeHolderManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING StakeHolderManagerForm_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION StakeHolderManagerForm_ui_uiInitializeDefaultActions(p_actionList)
...
PUBLIC FUNCTION StakeHolderManagerForm_ui_initializeDefaultUISettings()
    DEFINE l_uiSettings UISettings_Type
...
#+
#+ @return None
FUNCTION StakeHolderManagerForm_ui_action_zm_client()
    DEFINE l_uiSettings UISettings_Type
    ...
    LET l_br_uk.clientstakeholders_clientId = m_record1_arrRecGrid[1].clientstakeholders_clientId
    INITIALIZE l_whereRelation TO NULL

    {<POINT Name="fct.action_zm_client.init">} {</POINT>}
    IF StakeHolderManagerForm_events.m_DlgEvent__action_zm_client_BeforeOpeningTheForm IS NOT NULL THEN
        CALL StakeHolderManagerForm_events.m_DlgEvent__action_zm_client_BeforeOpeningTheForm(m_state)
    END IF

    CALL ClientZoom_ui_uiOpenFormByKey(l_whereRelation, l_uiSettings.*, l_br_uk.*) RETURNING errNo, actionNo, l_br_uk.*

    IF StakeHolderManagerForm_events.m_DlgEvent__action_zm_client_AfterClosingTheForm IS NOT NULL THEN
        CALL StakeHolderManagerForm_events.m_DlgEvent__action_zm_client_AfterClosingTheForm(m_state)
    END IF
...
FUNCTION StakeHolderManagerForm_ui_validateCRUDOperationWrapper(p_dialog, p_subdialog_name, p_state, p_action)
    ...
    CASE p_subdialog_name
        WHEN "record1"
            CALL StakeHolderManagerForm_uidialog.StakeHolderManagerForm_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
                RETURNING l_internalAction
    END CASE
