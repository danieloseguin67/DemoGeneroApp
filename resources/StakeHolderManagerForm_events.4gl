...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE clientstakeholders.*) RETURNS (INTEGER, STRING, RECORD LIKE clientstakeholders.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE clientstakeholders.*, p_dataT1 RECORD LIKE clientstakeholders.*) RETURNS (INTEGER, STRING, RECORD LIKE clientstakeholders.*, RECORD LIKE clientstakeholders.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE clientstakeholders.*) RETURNS (INTEGER, STRING, RECORD LIKE clientstakeholders.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE clientstakeholders.*) RETURNS (INTEGER, STRING)
