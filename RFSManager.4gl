{<CODEFILE Path="RFSManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL RFSManager_install()

    CONNECT TO "consultcompanion"

    CALL RFSManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION RFSManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION RFSManager_openFirstForm()
    ...
    CALL RFSManagerform_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
