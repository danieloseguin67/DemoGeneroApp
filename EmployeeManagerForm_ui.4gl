{<CODEFILE Path="EmployeeManagerForm.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ User Interface
...
IMPORT FGL EmployeeManagerForm_uidialog
...
PUBLIC FUNCTION EmployeeManagerForm_ui_uiOpenForm(p_whereRelation, p_uiSettings)
    ...
    CALL EmployeeManagerForm_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings.*, l_record1_br_uk.*) RETURNING errNo, actionNo, l_record1_br_uk.*
...
PUBLIC FUNCTION EmployeeManagerForm_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings, p_br_uk)
    DEFINE p_whereRelation STRING
    DEFINE p_uiSettings UISettings_Type
    ...
    OPEN WINDOW w_EmployeeManagerForm WITH FORM 'EmployeeManagerForm' ATTRIBUTES(STYLE=NVL(l_windowStyle, "main_dbapp"))
    --Initialize UI settings with default form UI settings
    CALL EmployeeManagerForm_ui_initializeDefaultUISettings() RETURNING l_defaultUISettings.*
    ...
    IF EmployeeManagerForm_events.m_DlgEvent_OnOpenForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent_OnOpenForm(w.getForm())
    END IF
    ...
    IF m_uiSettings.openMode != C_MODE_SEARCH AND m_uiSettings.openMode != C_MODE_EMPTY THEN
        ...
        LET m_record1_keyIndex = EmployeeManagerForm_uidialogdata_record1_seek(p_br_uk.*)
    END IF
    --Call the UI automaton
    CALL EmployeeManagerForm_ui_uiAutomaton(m_uiSettings.*) RETURNING errNo, actionNo
    INITIALIZE l_record1_br_uk.* TO NULL
    IF m_record1_keyIndex > 0 THEN
        LET l_record1_br_uk.employees_employeeid = m_record1_arrRecList[m_record1_keyIndex].employees_employeeid
    END IF
    CLOSE WINDOW w_EmployeeManagerForm
...
PRIVATE FUNCTION EmployeeManagerForm_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL EmployeeManagerForm_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_MODIFY
                ...
                CALL EmployeeManagerForm_ui_uiInput(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL EmployeeManagerForm_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL EmployeeManagerForm_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION EmployeeManagerForm_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG EmployeeManagerForm_uidialog.EmployeeManagerForm_uidialog_record1_uiDisplay
        ...
        ON ACTION new
            ...
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionNew IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionNew(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
        ...
        ON ACTION query
            ...
            LET EmployeeManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION accept
            ...
            LET EmployeeManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionAccept IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionAccept(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION cancel
            ...
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionCancel IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionCancel(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION close
            ...
            LET EmployeeManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionClose IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionClose(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION exit
            ...
            LET EmployeeManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionExit IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionExit(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE DIALOG
            ...
            LET EmployeeManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF EmployeeManagerForm_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            ...
            IF EmployeeManagerForm_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
...
#+ @return           Error number, 0-success, other-error
#+ @return           The next performed action
FUNCTION EmployeeManagerForm_ui_uiInput(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    END RECORD
    DEFINE l_br_uk_zm_emptype RECORD
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG EmployeeManagerForm_uidialog.EmployeeManagerForm_uidialog_record1_uiInput

        ON ACTION zm_provinces
            {<POINT Name="fct.uiInput.dlg.onAction.zm_provinces">} {</POINT>}
            CALL EmployeeManagerForm_ui_action_zm_provinces() RETURNING errNo, actionNo, l_br_uk_zm_provinces.*
            IF errNo == ERROR_SUCCESS THEN
                ...
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    IF m_record1_arrRecList.getLength() > 0 THEN
                        IF (m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_provinceId IS NULL) OR (m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_provinceId != l_br_uk_zm_provinces.employees_provinceId) THEN
                            CALL DIALOG.setFieldTouched("record1.provinceId", TRUE)
                            LET m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_provinceId = l_br_uk_zm_provinces.employees_provinceId
            ...
            END IF
        ON ACTION zm_emptype
            {<POINT Name="fct.uiInput.dlg.onAction.zm_emptype">} {</POINT>}
            CALL EmployeeManagerForm_ui_action_zm_emptype() RETURNING errNo, actionNo, l_br_uk_zm_emptype.*
            IF errNo == ERROR_SUCCESS THEN
                IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                    LET m_actionNo = C_ACTION_EXIT_APP
                    LET m_dataProcessing = TRUE
                ...
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    IF m_record1_arrRecList.getLength() > 0 THEN
                        IF (m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_emptype IS NULL) OR (m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_emptype != l_br_uk_zm_emptype.employees_emptype) THEN
                            CALL DIALOG.setFieldTouched("record1.emptype", TRUE)
                            LET m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_emptype = l_br_uk_zm_emptype.employees_emptype
                            --The 'NEXT FIELD CURRENT' is done to trigger existing 'ON CHANGE'.
                            --Especially in the following case:
                            --  - The value of the field is 'A'
                            --  - Select a value 'B' using the ZOOM functionality
        ...
        ON ACTION zm_country
            ...
            CALL EmployeeManagerForm_ui_action_zm_country() RETURNING errNo, actionNo, l_br_uk_zm_country.*
            IF errNo == ERROR_SUCCESS THEN
                IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                    LET m_actionNo = C_ACTION_EXIT_APP
                    LET m_dataProcessing = TRUE
                ...
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    IF m_record1_arrRecList.getLength() > 0 THEN
                        IF (m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_countryid IS NULL) OR (m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_countryid != l_br_uk_zm_country.employees_countryid) THEN
                            CALL DIALOG.setFieldTouched("record1.countryid", TRUE)
                            LET m_record1_arrRecList[DIALOG.getCurrentRow("record1")].employees_countryid = l_br_uk_zm_country.employees_countryid
                            --The 'NEXT FIELD CURRENT' is done to trigger existing 'ON CHANGE'.
                            --Especially in the following case:
                            --  - The value of the field is 'A'
                            --  - Select a value 'B' using the ZOOM functionality
        ...
        ON ACTION zoom
            ...
            IF INFIELD(record1.provinceId) THEN
                ...
                END IF
            END IF
            IF INFIELD(record1.emptype) THEN
                CALL EmployeeManagerForm_ui_action_zm_emptype() RETURNING errNo, actionNo, l_br_uk_zm_emptype.*
                IF errNo == ERROR_SUCCESS THEN
                    IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                        LET m_actionNo = C_ACTION_EXIT_APP
        ...
        ON ACTION cancel
            ...
            CALL EmployeeManagerForm_ui_validateCRUDOperationWrapper(DIALOG, m_subdialog, m_state, C_ACTION_CANCEL)
        ...
        AFTER DIALOG
            INITIALIZE EmployeeManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF EmployeeManagerForm_events.m_DlgEvent_After_EditDialog IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_After_EditDialog(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION EmployeeManagerForm_ui_uiConstruct(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG EmployeeManagerForm_uidialog.EmployeeManagerForm_uidialog_record1_uiConstruct
        ...
        ON ACTION zm_provinces
            ...
            IF errNo == ERROR_SUCCESS THEN
                ...
                END IF
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    DISPLAY l_br_uk_zm_provinces.employees_provinceId TO employees.provinceId
                END IF
            ELSE
                MESSAGE "Error on the zoom"
            END IF
        ON ACTION zm_emptype
            {<POINT Name="fct.uiConstruct.dlg.onAction.zm_emptype">} {</POINT>}
            CALL EmployeeManagerForm_ui_action_zm_emptype() RETURNING errNo, actionNo, l_br_uk_zm_emptype.*
            IF errNo == ERROR_SUCCESS THEN
                IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                    LET m_actionNo = C_ACTION_EXIT_APP
                ...
                END IF
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    DISPLAY l_br_uk_zm_emptype.employees_emptype TO employees.emptype
                END IF
            ELSE
                MESSAGE "Error on the zoom"
            END IF
        ON ACTION zm_country
            ...
            IF errNo == ERROR_SUCCESS THEN
                ...
                END IF
                IF actionNo == C_ACTION_ACCEPT THEN --Handle the return value of the zoom
                    DISPLAY l_br_uk_zm_country.employees_countryid TO employees.countryid
                END IF
            ELSE
                MESSAGE "Error on the zoom"
            END IF
        ON ACTION zoom
            ...
            IF INFIELD(employees.provinceId) THEN
                CALL EmployeeManagerForm_ui_action_zm_provinces() RETURNING errNo, actionNo, l_br_uk_zm_provinces.*
                IF errNo == ERROR_SUCCESS THEN
                    IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                        LET m_actionNo = C_ACTION_EXIT_APP
                ...
                END IF
            END IF
            IF INFIELD(employees.emptype) THEN
                CALL EmployeeManagerForm_ui_action_zm_emptype() RETURNING errNo, actionNo, l_br_uk_zm_emptype.*
                IF errNo == ERROR_SUCCESS THEN
                    IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                        LET m_actionNo = C_ACTION_EXIT_APP
                ...
                END IF
            END IF
            IF INFIELD(employees.countryid) THEN
                CALL EmployeeManagerForm_ui_action_zm_country() RETURNING errNo, actionNo, l_br_uk_zm_country.*
                IF errNo == ERROR_SUCCESS THEN
                    IF actionNo == C_ACTION_EXIT_APP THEN --Exit Application was raised on the zoom, then the application should be closed without handle the return value of the zoom
                        LET m_actionNo = C_ACTION_EXIT_APP
        ...
        BEFORE DIALOG
            ...
            INITIALIZE EmployeeManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF EmployeeManagerForm_events.m_DlgEvent_Before_SearchDialog IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_Before_SearchDialog(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
            CASE EmployeeManagerForm_events.m_DlgCtrlInstruction
                WHEN libdbappEvents.ACCEPT_DIALOG
        ...
        AFTER DIALOG
            ...
            INITIALIZE EmployeeManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF EmployeeManagerForm_events.m_DlgEvent_After_SearchDialog IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_After_SearchDialog(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction, m_where, m_detailList)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction, m_where, m_detailList
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION EmployeeManagerForm_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE EmployeeManagerForm_events.m_DlgCtrlInstruction TO NULL
        IF EmployeeManagerForm_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL EmployeeManagerForm_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION new
            ...
            LET EmployeeManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF EmployeeManagerForm_events.m_DlgEvent_OnActionNew IS NOT NULL THEN
                CALL EmployeeManagerForm_events.m_DlgEvent_OnActionNew(DIALOG, m_state, EmployeeManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING EmployeeManagerForm_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION EmployeeManagerForm_ui_uiInitializeDefaultActions(p_actionList)
    ...
    LET p_actionList[15] = "zm_emptype"
    LET p_actionList[16] = "zm_country"
...
PUBLIC FUNCTION EmployeeManagerForm_ui_initializeDefaultUISettings()
    DEFINE l_uiSettings UISettings_Type
...
#+
#+ @return None
FUNCTION EmployeeManagerForm_ui_action_zm_provinces()
    DEFINE l_uiSettings UISettings_Type
    ...
    LET l_br_uk.employees_provinceId = IIF(m_record1_keyIndex > 0, m_record1_arrRecList[m_record1_keyIndex].employees_provinceId, NULL)
    LET l_whereRelation = SFMT("provinces.countryid='%1'", IIF(m_record1_keyIndex > 0, m_record1_arrRecList[m_record1_keyIndex].employees_countryid, NULL))

    {<POINT Name="fct.action_zm_provinces.init">} {</POINT>}
    IF EmployeeManagerForm_events.m_DlgEvent__action_zm_provinces_BeforeOpeningTheForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent__action_zm_provinces_BeforeOpeningTheForm(m_state)
    END IF

    CALL ProvinceZoom_ui_uiOpenFormByKey(l_whereRelation, l_uiSettings.*, l_br_uk.*) RETURNING errNo, actionNo, l_br_uk.*

    IF EmployeeManagerForm_events.m_DlgEvent__action_zm_provinces_AfterClosingTheForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent__action_zm_provinces_AfterClosingTheForm(m_state)
    END IF
...
{<BLOCK Name="fct.action_zm_emptype">}
#+ Launch the module
#+
#+
#+ @return None
FUNCTION EmployeeManagerForm_ui_action_zm_emptype()
    DEFINE l_uiSettings UISettings_Type
    ...
    DEFINE errNo INTEGER
    DEFINE actionNo SMALLINT
    {<POINT Name="fct.action_zm_emptype.define">} {</POINT>}
    ...
    LET l_br_uk.employees_emptype = IIF(m_record1_keyIndex > 0, m_record1_arrRecList[m_record1_keyIndex].employees_emptype, NULL)
    INITIALIZE l_whereRelation TO NULL

    {<POINT Name="fct.action_zm_emptype.init">} {</POINT>}
    IF EmployeeManagerForm_events.m_DlgEvent__action_zm_emptype_BeforeOpeningTheForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent__action_zm_emptype_BeforeOpeningTheForm(m_state)
    END IF

    CALL EmployeeTypeZoom_ui_uiOpenFormByKey(l_whereRelation, l_uiSettings.*, l_br_uk.*) RETURNING errNo, actionNo, l_br_uk.*

    IF EmployeeManagerForm_events.m_DlgEvent__action_zm_emptype_AfterClosingTheForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent__action_zm_emptype_AfterClosingTheForm(m_state)
    END IF

    RETURN errNo, actionNo, l_br_uk.*
END FUNCTION
{</BLOCK>} --fct.action_zm_emptype
...
#+
#+ @return None
FUNCTION EmployeeManagerForm_ui_action_zm_country()
    DEFINE l_uiSettings UISettings_Type
    ...
    LET l_br_uk.employees_countryid = IIF(m_record1_keyIndex > 0, m_record1_arrRecList[m_record1_keyIndex].employees_countryid, NULL)
    INITIALIZE l_whereRelation TO NULL

    {<POINT Name="fct.action_zm_country.init">} {</POINT>}
    IF EmployeeManagerForm_events.m_DlgEvent__action_zm_country_BeforeOpeningTheForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent__action_zm_country_BeforeOpeningTheForm(m_state)
    END IF

    CALL CountryZoom_ui_uiOpenFormByKey(l_whereRelation, l_uiSettings.*, l_br_uk.*) RETURNING errNo, actionNo, l_br_uk.*

    IF EmployeeManagerForm_events.m_DlgEvent__action_zm_country_AfterClosingTheForm IS NOT NULL THEN
        CALL EmployeeManagerForm_events.m_DlgEvent__action_zm_country_AfterClosingTheForm(m_state)
    END IF
...
FUNCTION EmployeeManagerForm_ui_validateCRUDOperationWrapper(p_dialog, p_subdialog_name, p_state, p_action)
    ...
    CASE p_subdialog_name
        WHEN "record1"
            CALL EmployeeManagerForm_uidialog.EmployeeManagerForm_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
                RETURNING l_internalAction
    END CASE
