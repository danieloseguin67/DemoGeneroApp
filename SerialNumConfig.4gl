...
MAIN
    ...
    CALL SerialNumConfig_install()

    CONNECT TO "consultcompanion"

    CALL SerialNumConfig_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION SerialNumConfig_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION SerialNumConfig_openFirstForm()
    ...
    CALL SerialNumConfigForm_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
