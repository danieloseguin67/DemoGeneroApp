{<CODEFILE Path="ClientManager.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ Main program
...
MAIN
    ...
    CALL ClientManager_install()

    CONNECT TO "consultcompanion"

    CALL ClientManager_openFirstForm() RETURNING errNo, actionNo
...
PUBLIC FUNCTION ClientManager_install()
    DEFINE src STRING
    DEFINE dest STRING
...
#+
#+ @return None
FUNCTION ClientManager_openFirstForm()
    ...
    CALL ClientManagerform_ui_uiOpenForm(l_whereRelation, l_uiSettings.*) RETURNING errNo, actionNo
