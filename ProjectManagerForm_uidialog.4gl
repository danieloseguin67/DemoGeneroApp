...
DIALOG ProjectManagerForm_uidialog_record1_uiDisplay()
    ...
    DISPLAY ARRAY m_record1_arrRecGrid TO record1.* ATTRIBUTES(COUNT=IIF(m_record1_arrKeyRec.getLength() <= 0, 1, m_record1_arrKeyRec.getLength()))
        BEFORE DISPLAY
            ...
            CALL ProjectManagerForm_uidialog_record1_setActionStates(DIALOG, C_MODE_DISPLAY)
            ...
            IF ProjectManagerForm_events.m_DlgEvent_record1_BeforeDisplay IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_BeforeDisplay(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
        ...
        BEFORE ROW
            ...
            IF (m_record1_keyIndex != DIALOG.getCurrentRow("record1") OR m_prevAction == C_ACTION_CANCEL) THEN
                ...
                CALL ProjectManagerForm_uidialog_record1_validateCRUDOperation(DIALOG, m_state, C_ACTION_REFRESH_CURRENT_ROW) RETURNING l_internalAction
            END IF
            CALL ProjectManagerForm_uidialog_setAllCurrentRow(DIALOG)
            IF m_record1_arrKeyRec.getLength() > 1 THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrKeyRec.getLength()
            END IF

            INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF ProjectManagerForm_events.m_DlgEvent_record1_BeforeRow IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_BeforeRow(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION append
            ...
            IF ProjectManagerForm_events.m_DlgEvent_record1_OnActionAppend IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_OnActionAppend(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION update
            ...
            LET ProjectManagerForm_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF ProjectManagerForm_events.m_DlgEvent_record1_OnActionUpdate IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_OnActionUpdate(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --DISPLAY (record1)
            ...
            CALL ProjectManagerForm_uidialog_record1_validateCRUDOperation(DIALOG, m_state, C_ACTION_DELETE) RETURNING l_internalAction
            ...
            INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF ProjectManagerForm_events.m_DlgEvent_record1_OnActionDelete IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_OnActionDelete(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER DISPLAY
        INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
        IF ProjectManagerForm_events.m_DlgEvent_record1_AfterDisplay IS NOT NULL THEN
            CALL ProjectManagerForm_events.m_DlgEvent_record1_AfterDisplay(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER ROW
        INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
        IF ProjectManagerForm_events.m_DlgEvent_record1_AfterRow IS NOT NULL THEN
            CALL ProjectManagerForm_events.m_DlgEvent_record1_AfterRow(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
        END IF
...
DIALOG ProjectManagerForm_uidialog_record1_uiInput()
    DEFINE l_internalAction SMALLINT
    DEFINE errNo INTEGER

    {<POINT Name="dlg.record1.uiInput.define">} {</POINT>}

    INPUT m_record1_arrRecGrid[1].projects_projectId,
        m_record1_arrRecGrid[1].projects_projectName
    ...
    ATTRIBUTES(WITHOUT DEFAULTS = TRUE)
        BEFORE INPUT
            ...
            IF m_navigation_direction != 0 THEN
                CALL ProjectManagerForm_uidialog_record1_navigate(DIALOG,C_MODE_MODIFY,m_navigation_direction)
            ...
            IF initializeUI THEN
                CALL ProjectManagerForm_uidialog_record1_setFieldActive(DIALOG, m_state)
            ...
            IF m_state == C_MODE_ADD THEN
                CALL ProjectManagerForm_uidialog_record1_navigate(DIALOG, C_MODE_ADD, 3)
                CALL ProjectManagerForm_uidialogdata_record1_setDefaultValues(DIALOG)
                CALL ProjectManagerForm_uidialogdata_record1_fetchDetails()
            END IF
            CALL ProjectManagerForm_uidialog_record1_setFieldActive(DIALOG, m_state)
            CALL ProjectManagerForm_uidialog_record1_setActionStates(DIALOG, m_state)
            CALL ProjectManagerForm_uidialog_setAllCurrentRow(DIALOG)
            IF m_record1_arrKeyRec.getLength() > 1 THEN
                MESSAGE m_record1_keyIndex, "/", m_record1_arrKeyRec.getLength()
            END IF
            ...
            INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
            IF ProjectManagerForm_events.m_DlgEvent_record1_BeforeInput IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_BeforeInput(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        AFTER INPUT
            ...
            CALL ProjectManagerForm_uidialog_record1_validateCRUDOperation(DIALOG, m_state, m_actionNo) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
            ...
            ELSE
                INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
            END IF
            IF ProjectManagerForm_events.m_DlgEvent_record1_AfterInput IS NOT NULL THEN
                CALL ProjectManagerForm_events.m_DlgEvent_record1_AfterInput(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                    RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION delete --MODIFY (record1)
            ...
            CALL ProjectManagerForm_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DELETE) RETURNING l_internalAction
            CASE l_internalAction
                WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                    CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                    LET m_dataProcessing = FALSE
        ...
        ON ACTION dialogtouched --INPUT (record1)
            ...
            IF m_state == C_MODE_MODIFY THEN
                CALL ProjectManagerForm_uidialog_record1_validateCRUDOperation(DIALOG, C_MODE_MODIFY, C_ACTION_DIALOGTOUCHED) RETURNING l_internalAction
                CASE l_internalAction
                    WHEN C_INTERNAL_ACTION_NEXT_FIELD_CURRENT --We remain in input mode
                        CALL DIALOG.nextField(FGL_DIALOG_GETFIELDNAME())
                        CONTINUE DIALOG
...
DIALOG ProjectManagerForm_uidialog_record1_uiConstruct()
    ...
    CONSTRUCT m_record1_where
        ...
        BEFORE CONSTRUCT
        INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
        IF ProjectManagerForm_events.m_DlgEvent_record1_BeforeConstruct IS NOT NULL THEN
            CALL ProjectManagerForm_events.m_DlgEvent_record1_BeforeConstruct(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
        END IF
        ...
        AFTER CONSTRUCT
        INITIALIZE ProjectManagerForm_events.m_DlgCtrlInstruction TO NULL
        IF ProjectManagerForm_events.m_DlgEvent_record1_AfterConstruct IS NOT NULL THEN
            CALL ProjectManagerForm_events.m_DlgEvent_record1_AfterConstruct(DIALOG, m_state, ProjectManagerForm_events.m_DlgCtrlInstruction)
                RETURNING ProjectManagerForm_events.m_DlgCtrlInstruction
        END IF
...
FUNCTION ProjectManagerForm_uidialog_record1_validateCRUDOperation(p_dialog, p_state, p_action)
    ...
    IF l_internalAction == C_INTERNAL_ACTION_PROCESS_OPERATION THEN
        ...
        IF l_action != C_ACTION_DELETE AND l_action != C_ACTION_DIALOGTOUCHED THEN
            ...
            END IF
        END IF
        CALL ProjectManagerForm_uidialog_record1_processCRUDOperation(l_action) RETURNING l_internalAction, l_rec_br_uk.*
    END IF
    IF l_internalAction != C_INTERNAL_ACTION_NEXT_FIELD_CURRENT AND l_internalAction != C_INTERNAL_EXIT_DIALOG THEN
        ...
        IF l_internalAction != C_INTERNAL_ACTION_NO_SYNC THEN
            CALL ProjectManagerForm_uidialog_record1_synchronizeUI(p_dialog, p_state, l_internalAction, l_rec_br_uk.*) RETURNING m_copy_record1.*
        END IF
...
FUNCTION ProjectManagerForm_uidialog_record1_processCRUDOperation(p_action)
    DEFINE p_action SMALLINT
    DEFINE l_internalAction SMALLINT
    DEFINE l_rec_br_uk record1_br_uk_type --key returned by INSERT operation
    DEFINE errNo INTEGER
    ...
    CASE p_action
        WHEN C_ACTION_APPEND --Insert the row in the database
            CALL ProjectManagerForm_uidata.ProjectManagerForm_uidata_record1_insertRow(m_record1_arrRecGrid[1].*) RETURNING errNo, errMsg, l_rec_br_uk.*
        WHEN C_ACTION_UPDATE --Update the row in the database
            CALL ProjectManagerForm_uidata.ProjectManagerForm_uidata_record1_updateRow(m_record1_arrRecGrid[1].*, m_record1_arrRecDB[1].*) RETURNING errNo, errMsg
        WHEN C_ACTION_DIALOGTOUCHED --Check the row in the database
            CALL ProjectManagerForm_uidata.ProjectManagerForm_uidata_record1_checkRowConcurrentAccess(m_record1_arrRecDB[1].*) RETURNING errNo, errMsg

        WHEN C_ACTION_DELETE --Delete the row in the database
            CALL ProjectManagerForm_uidata.ProjectManagerForm_uidata_record1_deleteRowWithConcurrentAccess(m_record1_arrRecDB[1].*) RETURNING errNo, errMsg
        OTHERWISE
         -- unexpected error
    END CASE
...
FUNCTION ProjectManagerForm_uidialog_record1_synchronizeUI(p_dialog, p_state, p_internalAction, p_rec_br_uk)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
        ...
        CASE l_internalAction
            WHEN C_INTERNAL_ACTION_SUCCESS
                IF p_state == C_MODE_ADD THEN
                    ...
                    LET m_record1_arrRecGrid[1].projects_projectId = p_rec_br_uk.projects_projectId --Refresh the inserted key value in the UI (may be a composite key) (Useful in the case of SERIALS which are known after the INSERT sql statement)
                END IF
                CALL ProjectManagerForm_uidialogdata_record1_fetchRowAndDetails() RETURNING errNo --Done to update the m_record1_arrRecDB
            ...
            WHEN C_INTERNAL_ACTION_RESTORE_DATA
                ...
                IF p_state == C_MODE_ADD THEN
                    ...
                    CALL ProjectManagerForm_uidialog_record1_validateCRUDOperation(p_dialog, p_state, C_ACTION_REFRESH_CURRENT_ROW) RETURNING l_internalAction
                END IF
    ...
    IF p_state != C_MODE_DISPLAY THEN
        ...
        CALL ProjectManagerForm_uidialog_record1_setFieldActive(p_dialog, p_state)
    END IF
    IF p_state == C_MODE_DISPLAY THEN
        CALL p_dialog.setArrayLength("record1", m_record1_arrKeyRec.getLength())
    END IF

    CALL ProjectManagerForm_uidialog_record1_setActionStates(p_dialog, p_state)
    IF m_record1_arrKeyRec.getLength() > 1 THEN
        MESSAGE m_record1_keyIndex, "/", m_record1_arrKeyRec.getLength()
    END IF
    LET m_copy_record1.* = m_record1_arrRecGrid[1].* --Keep a local copy
...
FUNCTION ProjectManagerForm_uidialog_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    ...
    IF ProjectManagerForm_events.m_DlgEvent_OnActionStatesChange IS NOT NULL THEN
        CALL ProjectManagerForm_events.m_DlgEvent_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
#+ @param p_dialog      The current DIALOG
#+ @param p_mode        The current mode
FUNCTION ProjectManagerForm_uidialog_record1_setActionStates(p_dialog, p_mode)
    DEFINE p_dialog ui.Dialog
    DEFINE p_mode SMALLINT
    {<POINT Name="fct.record1_setActionStates.define">} {</POINT>}

    --Sets the state of the DIALOG actions
    CALL ProjectManagerForm_uidialog_setActionStates(p_dialog, p_mode)
    ...
    IF ProjectManagerForm_events.m_DlgEvent_record1_OnActionStatesChange IS NOT NULL THEN
        CALL ProjectManagerForm_events.m_DlgEvent_record1_OnActionStatesChange(p_dialog, p_mode)
    END IF
END FUNCTION
...
PUBLIC FUNCTION ProjectManagerForm_uidialog_record1_setFieldActive(p_dialog, p_state)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
    {<POINT Name="fct.record1_setFieldActive.define">} {</POINT>}
    {<POINT Name="fct.record1_setFieldActive.init">} {</POINT>}

    CALL p_dialog.setFieldActive("projects.projectid", p_state == C_MODE_ADD)

    {<POINT Name="fct.record1_setFieldActive.user">} {</POINT>}
    IF ProjectManagerForm_events.m_DlgEvent_record1_OnFieldsActivation IS NOT NULL THEN
        CALL ProjectManagerForm_events.m_DlgEvent_record1_OnFieldsActivation(p_dialog, p_state)
    END IF
END FUNCTION
...
#+                    3 to add a row
FUNCTION ProjectManagerForm_uidialog_record1_navigate(p_dialog, p_state, p_direction)
    DEFINE p_dialog ui.Dialog
    DEFINE p_state SMALLINT
...
#+
#+ @param p_dialog The current DIALOG
PUBLIC FUNCTION ProjectManagerForm_uidialog_setAllCurrentRow(p_dialog)
    DEFINE p_dialog ui.Dialog
