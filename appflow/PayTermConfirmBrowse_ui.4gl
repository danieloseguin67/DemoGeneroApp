{<CODEFILE Path="PayTermConfirmBrowse.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ User Interface
...
IMPORT FGL PayTermConfirmBrowse_common
IMPORT FGL PayTermConfirmBrowse
IMPORT FGL PayTermConfirmBrowse_events
IMPORT FGL PayTermConfirmBrowse_uidata
IMPORT FGL PayTermConfirmBrowse_uidialogdata
IMPORT FGL PayTermConfirmBrowse_uidialog
...
PUBLIC FUNCTION PayTermConfirmBrowse_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings, p_br_uk)
    ...
    OPEN WINDOW w_PayTermConfirmBrowse WITH FORM 'PayTermConfirmBrowse' ATTRIBUTES(STYLE=NVL(l_windowStyle, "zoom_dbapp"))
    --Initialize UI settings with default form UI settings
    CALL PayTermConfirmBrowse_ui_initializeDefaultUISettings() RETURNING l_defaultUISettings.*
    ...
    CALL PayTermConfirmBrowse_events.registerDlgEvents()
    CALL consultcompanion_events.registerDbxEvents()

    --Load actions in the ToolBar and the TopMenu
    IF NOT libdbapp_isMobile() THEN
        CALL PayTermConfirmBrowse_ui_uiInitializeDefaultActions(l_actionList)
    ...
    IF PayTermConfirmBrowse_events.m_DlgEvent_OnOpenForm IS NOT NULL THEN
        CALL PayTermConfirmBrowse_events.m_DlgEvent_OnOpenForm(w.getForm())
    END IF
    ...
    IF m_uiSettings.openMode != C_MODE_SEARCH AND m_uiSettings.openMode != C_MODE_EMPTY THEN
        CALL PayTermConfirmBrowse_uidialogdata_record1_fetchAll(m_where, m_detailList)
        LET m_record1_keyIndex = PayTermConfirmBrowse_uidialogdata_record1_seek(p_br_uk.*)
    END IF
    --Call the UI automaton
    CALL PayTermConfirmBrowse_ui_uiAutomaton(m_uiSettings.*) RETURNING errNo, actionNo
    ...
    END IF
    CLOSE WINDOW w_PayTermConfirmBrowse
...
PRIVATE FUNCTION PayTermConfirmBrowse_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL PayTermConfirmBrowse_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL PayTermConfirmBrowse_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL PayTermConfirmBrowse_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION PayTermConfirmBrowse_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG PayTermConfirmBrowse_uidialog.PayTermConfirmBrowse_uidialog_record1_uiDisplay

        ON ACTION query
            {<POINT Name="fct.uiDisplay.dlg.onAction.query">} {</POINT>}
            LET m_actionNo = C_ACTION_QUERY

            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF PayTermConfirmBrowse_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF

            CASE PayTermConfirmBrowse_events.m_DlgCtrlInstruction
        ...
        ON ACTION accept
            ...
            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF PayTermConfirmBrowse_events.m_DlgEvent_OnActionAccept IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_OnActionAccept(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION cancel
            ...
            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF PayTermConfirmBrowse_events.m_DlgEvent_OnActionCancel IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_OnActionCancel(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION close
            ...
            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF PayTermConfirmBrowse_events.m_DlgEvent_OnActionClose IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_OnActionClose(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION exit
            ...
            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF PayTermConfirmBrowse_events.m_DlgEvent_OnActionExit IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_OnActionExit(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE DIALOG
            ...
            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF PayTermConfirmBrowse_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            INITIALIZE PayTermConfirmBrowse_events.m_DlgCtrlInstruction TO NULL
            IF PayTermConfirmBrowse_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION PayTermConfirmBrowse_ui_uiConstruct(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG PayTermConfirmBrowse_uidialog.PayTermConfirmBrowse_uidialog_record1_uiConstruct
        ...
        BEFORE DIALOG
            ...
            INITIALIZE PayTermConfirmBrowse_events.m_DlgCtrlInstruction TO NULL
            IF PayTermConfirmBrowse_events.m_DlgEvent_Before_SearchDialog IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_Before_SearchDialog(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
            CASE PayTermConfirmBrowse_events.m_DlgCtrlInstruction
                WHEN libdbappEvents.ACCEPT_DIALOG
        ...
        AFTER DIALOG
            ...
            INITIALIZE PayTermConfirmBrowse_events.m_DlgCtrlInstruction TO NULL
            IF PayTermConfirmBrowse_events.m_DlgEvent_After_SearchDialog IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_After_SearchDialog(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction, m_where, m_detailList)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction, m_where, m_detailList
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION PayTermConfirmBrowse_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE PayTermConfirmBrowse_events.m_DlgCtrlInstruction TO NULL
        IF PayTermConfirmBrowse_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL PayTermConfirmBrowse_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION query
            ...
            LET PayTermConfirmBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF PayTermConfirmBrowse_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL PayTermConfirmBrowse_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, PayTermConfirmBrowse_events.m_DlgCtrlInstruction)
                    RETURNING PayTermConfirmBrowse_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION PayTermConfirmBrowse_ui_uiInitializeDefaultActions(p_actionList)
...
PUBLIC FUNCTION PayTermConfirmBrowse_ui_initializeDefaultUISettings()
