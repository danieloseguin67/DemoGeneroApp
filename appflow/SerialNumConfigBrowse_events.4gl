...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE seqreg.*) RETURNS (INTEGER, STRING, RECORD LIKE seqreg.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE seqreg.*, p_dataT1 RECORD LIKE seqreg.*) RETURNS (INTEGER, STRING, RECORD LIKE seqreg.*, RECORD LIKE seqreg.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE seqreg.*) RETURNS (INTEGER, STRING, RECORD LIKE seqreg.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE seqreg.*) RETURNS (INTEGER, STRING)
