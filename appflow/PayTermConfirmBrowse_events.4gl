...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE paymentterms.*) RETURNS (INTEGER, STRING, RECORD LIKE paymentterms.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE paymentterms.*, p_dataT1 RECORD LIKE paymentterms.*) RETURNS (INTEGER, STRING, RECORD LIKE paymentterms.*, RECORD LIKE paymentterms.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE paymentterms.*) RETURNS (INTEGER, STRING, RECORD LIKE paymentterms.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE paymentterms.*) RETURNS (INTEGER, STRING)
