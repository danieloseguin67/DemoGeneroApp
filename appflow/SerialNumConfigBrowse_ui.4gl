{<CODEFILE Path="SerialNumConfigBrowse.code" Hash="1B2M2Y8AsgTpgAmY7PhCfg==" />}
#+ User Interface
...
IMPORT FGL SerialNumConfigBrowse_common
IMPORT FGL SerialNumConfigBrowse
IMPORT FGL SerialNumConfigBrowse_events
IMPORT FGL SerialNumConfigBrowse_uidata
IMPORT FGL SerialNumConfigBrowse_uidialogdata
IMPORT FGL SerialNumConfigBrowse_uidialog
...
PUBLIC FUNCTION SerialNumConfigBrowse_ui_uiOpenFormByKey(p_whereRelation, p_uiSettings, p_br_uk)
    ...
    OPEN WINDOW w_SerialNumConfigBrowse WITH FORM 'SerialNumConfigBrowse' ATTRIBUTES(STYLE=NVL(l_windowStyle, "zoom_dbapp"))
    --Initialize UI settings with default form UI settings
    CALL SerialNumConfigBrowse_ui_initializeDefaultUISettings() RETURNING l_defaultUISettings.*
    ...
    CALL SerialNumConfigBrowse_events.registerDlgEvents()
    CALL consultcompanion_events.registerDbxEvents()

    --Load actions in the ToolBar and the TopMenu
    IF NOT libdbapp_isMobile() THEN
        CALL SerialNumConfigBrowse_ui_uiInitializeDefaultActions(l_actionList)
    ...
    IF SerialNumConfigBrowse_events.m_DlgEvent_OnOpenForm IS NOT NULL THEN
        CALL SerialNumConfigBrowse_events.m_DlgEvent_OnOpenForm(w.getForm())
    END IF
    ...
    IF m_uiSettings.openMode != C_MODE_SEARCH AND m_uiSettings.openMode != C_MODE_EMPTY THEN
        CALL SerialNumConfigBrowse_uidialogdata_record1_fetchAll(m_where, m_detailList)
        LET m_record1_keyIndex = SerialNumConfigBrowse_uidialogdata_record1_seek(p_br_uk.*)
    END IF
    --Call the UI automaton
    CALL SerialNumConfigBrowse_ui_uiAutomaton(m_uiSettings.*) RETURNING errNo, actionNo
    INITIALIZE l_record1_br_uk.* TO NULL
    IF m_record1_keyIndex > 0 THEN
        LET l_record1_br_uk.seqreg_sr_name = m_record1_arrRecList[m_record1_keyIndex].seqreg_sr_name
    END IF
    CLOSE WINDOW w_SerialNumConfigBrowse
...
PRIVATE FUNCTION SerialNumConfigBrowse_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL SerialNumConfigBrowse_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL SerialNumConfigBrowse_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL SerialNumConfigBrowse_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION SerialNumConfigBrowse_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG SerialNumConfigBrowse_uidialog.SerialNumConfigBrowse_uidialog_record1_uiDisplay

        ON ACTION query
            {<POINT Name="fct.uiDisplay.dlg.onAction.query">} {</POINT>}
            LET m_actionNo = C_ACTION_QUERY

            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF SerialNumConfigBrowse_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF

            CASE SerialNumConfigBrowse_events.m_DlgCtrlInstruction
        ...
        ON ACTION accept
            ...
            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.ACCEPT_DIALOG
            IF SerialNumConfigBrowse_events.m_DlgEvent_OnActionAccept IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_OnActionAccept(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION cancel
            ...
            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF SerialNumConfigBrowse_events.m_DlgEvent_OnActionCancel IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_OnActionCancel(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION close
            ...
            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF SerialNumConfigBrowse_events.m_DlgEvent_OnActionClose IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_OnActionClose(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        ON ACTION exit
            ...
            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_DIALOG
            IF SerialNumConfigBrowse_events.m_DlgEvent_OnActionExit IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_OnActionExit(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
        ...
        BEFORE DIALOG
            ...
            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF SerialNumConfigBrowse_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            INITIALIZE SerialNumConfigBrowse_events.m_DlgCtrlInstruction TO NULL
            IF SerialNumConfigBrowse_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION SerialNumConfigBrowse_ui_uiConstruct(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG SerialNumConfigBrowse_uidialog.SerialNumConfigBrowse_uidialog_record1_uiConstruct
        ...
        BEFORE DIALOG
            ...
            INITIALIZE SerialNumConfigBrowse_events.m_DlgCtrlInstruction TO NULL
            IF SerialNumConfigBrowse_events.m_DlgEvent_Before_SearchDialog IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_Before_SearchDialog(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
            CASE SerialNumConfigBrowse_events.m_DlgCtrlInstruction
                WHEN libdbappEvents.ACCEPT_DIALOG
        ...
        AFTER DIALOG
            ...
            INITIALIZE SerialNumConfigBrowse_events.m_DlgCtrlInstruction TO NULL
            IF SerialNumConfigBrowse_events.m_DlgEvent_After_SearchDialog IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_After_SearchDialog(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction, m_where, m_detailList)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction, m_where, m_detailList
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION SerialNumConfigBrowse_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE SerialNumConfigBrowse_events.m_DlgCtrlInstruction TO NULL
        IF SerialNumConfigBrowse_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL SerialNumConfigBrowse_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION query
            ...
            LET SerialNumConfigBrowse_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF SerialNumConfigBrowse_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL SerialNumConfigBrowse_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, SerialNumConfigBrowse_events.m_DlgCtrlInstruction)
                    RETURNING SerialNumConfigBrowse_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION SerialNumConfigBrowse_ui_uiInitializeDefaultActions(p_actionList)
...
PUBLIC FUNCTION SerialNumConfigBrowse_ui_initializeDefaultUISettings()
