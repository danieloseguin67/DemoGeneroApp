...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE offerstatuses.*) RETURNS (INTEGER, STRING, RECORD LIKE offerstatuses.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE offerstatuses.*, p_dataT1 RECORD LIKE offerstatuses.*) RETURNS (INTEGER, STRING, RECORD LIKE offerstatuses.*, RECORD LIKE offerstatuses.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE offerstatuses.*) RETURNS (INTEGER, STRING, RECORD LIKE offerstatuses.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE offerstatuses.*) RETURNS (INTEGER, STRING)
