...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE employeetypes.*) RETURNS (INTEGER, STRING, RECORD LIKE employeetypes.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE employeetypes.*, p_dataT1 RECORD LIKE employeetypes.*) RETURNS (INTEGER, STRING, RECORD LIKE employeetypes.*, RECORD LIKE employeetypes.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE employeetypes.*) RETURNS (INTEGER, STRING, RECORD LIKE employeetypes.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE employeetypes.*) RETURNS (INTEGER, STRING)
