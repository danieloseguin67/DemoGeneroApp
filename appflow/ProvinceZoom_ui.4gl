...
IMPORT FGL ProvinceZoom_uidialog
...
PRIVATE FUNCTION ProvinceZoom_ui_uiAutomaton(p_uiSettings)
    DEFINE p_uiSettings UISettings_Type
    ...
    WHILE runningAutomaton
        CASE l_state
            ...
            WHEN C_MODE_DISPLAY
                ...
                CALL ProvinceZoom_ui_uiDisplay(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_SEARCH
                ...
                CALL ProvinceZoom_ui_uiConstruct(prevState, prevAction, l_state) RETURNING errNo, actionNo
            ...
            WHEN C_MODE_EMPTY
                ...
                CALL ProvinceZoom_ui_uiEmpty(prevState, prevAction, l_state) RETURNING errNo, actionNo
...
FUNCTION ProvinceZoom_ui_uiDisplay(p_prevState, p_prevAction, p_state)
    ...
    DIALOG ATTRIBUTES(UNBUFFERED, FIELD ORDER FORM)
        SUBDIALOG ProvinceZoom_uidialog.ProvinceZoom_uidialog_record1_uiDisplay
        ...
        ON ACTION query
            ...
            IF ProvinceZoom_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL ProvinceZoom_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, ProvinceZoom_events.m_DlgCtrlInstruction)
        ...
        BEFORE DIALOG
            ...
            LET ProvinceZoom_events.m_DlgCtrlInstruction = libdbappEvents.CONTINUE_DIALOG
            IF ProvinceZoom_events.m_DlgEvent_Before_BrowseDialog IS NOT NULL THEN
                CALL ProvinceZoom_events.m_DlgEvent_Before_BrowseDialog(DIALOG, m_state, ProvinceZoom_events.m_DlgCtrlInstruction, m_NextField)
                    RETURNING ProvinceZoom_events.m_DlgCtrlInstruction, m_NextField
            END IF
        ...
        AFTER DIALOG
            ...
            IF ProvinceZoom_events.m_DlgEvent_After_BrowseDialog IS NOT NULL THEN
                CALL ProvinceZoom_events.m_DlgEvent_After_BrowseDialog(DIALOG, m_state, ProvinceZoom_events.m_DlgCtrlInstruction)
                    RETURNING ProvinceZoom_events.m_DlgCtrlInstruction
            END IF
...
#+ @return             Error number, 0-success, other-error
#+ @return             The next performed action
FUNCTION ProvinceZoom_ui_uiEmpty(p_prevState, p_prevAction, p_state)
    DEFINE p_prevState SMALLINT
    DEFINE p_prevAction SMALLINT
    DEFINE p_state SMALLINT
    DEFINE errNo INTEGER
    ...
    MENU
        BEFORE MENU
            ...
            END IF
        INITIALIZE ProvinceZoom_events.m_DlgCtrlInstruction TO NULL
        IF ProvinceZoom_events.m_DlgEvent_Before_EmptyDialog IS NOT NULL THEN
            CALL ProvinceZoom_events.m_DlgEvent_Before_EmptyDialog(DIALOG, m_state, ProvinceZoom_events.m_DlgCtrlInstruction)
                RETURNING ProvinceZoom_events.m_DlgCtrlInstruction
        END IF
        ...
        ON ACTION query
            ...
            LET ProvinceZoom_events.m_DlgCtrlInstruction = libdbappEvents.EXIT_MENU
            IF ProvinceZoom_events.m_DlgEvent_OnActionQuery IS NOT NULL THEN
                CALL ProvinceZoom_events.m_DlgEvent_OnActionQuery(DIALOG, m_state, ProvinceZoom_events.m_DlgCtrlInstruction)
                    RETURNING ProvinceZoom_events.m_DlgCtrlInstruction
            END IF
...
PUBLIC FUNCTION ProvinceZoom_ui_uiInitializeDefaultActions(p_actionList)
...
PUBLIC FUNCTION ProvinceZoom_ui_initializeDefaultUISettings()
