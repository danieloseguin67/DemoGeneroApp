...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE provinces.*) RETURNS (INTEGER, STRING, RECORD LIKE provinces.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE provinces.*, p_dataT1 RECORD LIKE provinces.*) RETURNS (INTEGER, STRING, RECORD LIKE provinces.*, RECORD LIKE provinces.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE provinces.*) RETURNS (INTEGER, STRING, RECORD LIKE provinces.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE provinces.*) RETURNS (INTEGER, STRING)
