...
PUBLIC TYPE T_DataEvent_record1_BeforeInsertRow FUNCTION(dataInsert RECORD LIKE clients.*) RETURNS (INTEGER, STRING, RECORD LIKE clients.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeUpdateRow FUNCTION(p_dataT0 RECORD LIKE clients.*, p_dataT1 RECORD LIKE clients.*) RETURNS (INTEGER, STRING, RECORD LIKE clients.*, RECORD LIKE clients.*)
...
PUBLIC TYPE T_DataEvent_record1_BeforeDeleteRowWithConcurrentAccess FUNCTION(p_dataT0 RECORD LIKE clients.*) RETURNS (INTEGER, STRING, RECORD LIKE clients.*)
PUBLIC TYPE T_DataEvent_record1_AfterDeleteRowWithConcurrentAccess FUNCTION(errNo INTEGER, errMsg STRING, p_dataT0 RECORD LIKE clients.*) RETURNS (INTEGER, STRING)
...
PUBLIC DEFINE m_DlgEvent__action_zm_provinces_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_provinces_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_payterm_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_payterm_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_clienttype_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_clienttype_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_country_BeforeOpeningTheForm T_DlgEvent_BeforeOpeningTheForm
PUBLIC DEFINE m_DlgEvent__action_zm_country_AfterClosingTheForm T_DlgEvent_AfterClosingTheForm
...
PUBLIC FUNCTION registerDlgEvents()
    ...
    LET m_DlgEvent_OnActionAccept = FUNCTION ClientManagerform.dlgEvent_OnActionAccept
    ...
    LET m_DataEvent_record1_BeforeInsertRow = FUNCTION ClientManagerform.dataEvent_record1_BeforeInsertRow
    LET m_DataEvent_record1_AfterInsertRow = FUNCTION ClientManagerform.dataEvent_record1_AfterInsertRow
